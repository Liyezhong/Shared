...
ARM_INC         := $(shell ts_pathname -s '$(COMPILER_INSTALL_PATH)/../INC/STM/STM32F10x')
DEVICE          := DARMSTM
...
S_LINK_OPTIONS := --library_type=microlib --device $(DEVICE) --scatter $(PROJECTROOT)\Tessy\startup_STM32F10x.sct --autoat --libpath $(ARM_DLLS)
