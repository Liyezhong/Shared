...
//! Air flow switch digital input
#define HAL_AIRFLOW_SWITCH  HAL_DIGITAL_INPUT_0

//! Level switch digital input
#define HAL_LEVEL_SWITCH    HAL_DIGITAL_INPUT_1

//! Reed relay active digital input
#define HAL_REED_ACTIVE     HAL_DIGITAL_INPUT_2

//! Exhaust air fan 1 control digital output
#define HAL_AIRFAN_CONTROL1 HAL_DIGITAL_OUTPUT_0

//! Exhaust air fan 2 control digital output
#define HAL_AIRFAN_CONTROL2 HAL_DIGITAL_OUTPUT_1

//! Light control digital output
#define HAL_LIGHT_CONTROL   HAL_DIGITAL_OUTPUT_2

//! Water valve control 1 digital output
#define HAL_VALVE_CONTROL1  HAL_DIGITAL_OUTPUT_3

//! Water valve control 2 digital output
#define HAL_VALVE_CONTROL2  HAL_DIGITAL_OUTPUT_4

//! Water valve control 3 digital output
#define HAL_VALVE_CONTROL3  HAL_DIGITAL_OUTPUT_5

//! Water valve control 4 digital output
#define HAL_VALVE_CONTROL4  HAL_DIGITAL_OUTPUT_6

//! Water valve control 5 digital output
#define HAL_VALVE_CONTROL5  HAL_DIGITAL_OUTPUT_7

//! Water valve control 6 digital output
#define HAL_VALVE_CONTROL6  HAL_DIGITAL_OUTPUT_8

//! Exhaust air fan 1 analog input
#define HAL_AIRFAN_CURRENT1 HAL_ANALOG_INPUT_0

//! Exhaust air fan 2 analog input
#define HAL_AIRFAN_CURRENT2 HAL_ANALOG_INPUT_1

//! Stepper motor 1 phase A current measurement
#define HAL_STEPPER1_PHASEA HAL_ANALOG_INPUT_2

//! Stepper motor 1 phase B current measurement
#define HAL_STEPPER1_PHASEB HAL_ANALOG_INPUT_3
...
// Timer 1 programmed for internal time reference (Stepper motor)
#define TIM1_MODE_MASTER    0x0000   //!< Timer slave mode
#define TIM1_MODE_CAPCOM1   0x0000   //!< Unit 1: Compare, output disable
#define TIM1_MODE_CAPCOM2   0x0000   //!< Unit 2: Compare, output disable
#define TIM1_MODE_CAPCOM3   0x0000   //!< Unit 3: Compare, output disable
#define TIM1_MODE_CAPCOM4   0x0000   //!< Unit 4: Compare, output disable

// Timer 2 programmed for quadrature encoder Encoder_ELVT_EQEP1
#define TIM2_MODE_MASTER    0x0000   //!< Timer slave mode
#define TIM2_MODE_CAPCOM1   0x1100   //!< Unit 1: Encoder input A
#define TIM2_MODE_CAPCOM2   0x1100   //!< Unit 2: Encoder input B
...
//  --------------------------------------
//
#define MAPPING_TIMER3   0   //!< Configured timer 3 pin mapping
...
//  --------------------------------------
//
#define MAPPING_USART2   1   //!< Configured Usart 2 pin mapping
