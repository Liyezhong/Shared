...
const halPinDesciptor_t halPinDescriptors[] = {
    { PORT_A,  0, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // ENCODER_X1_EQEP1A/TIM2_CH1
    { PORT_A,  1, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // ENCODER_X1_EQEP1B/TIM2_CH2
    { PORT_A,  2, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // ENCODER_X1_EQEP1I/TIM2_CH3
    { PORT_A,  3, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // X1_LIMITSWITCH
    { PORT_A,  4, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // #STEPPER_X1_SPIENABLE
    { PORT_A,  5, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // STEPPER_X1_SPISCK/SPI1_SCK
    { PORT_A,  6, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // STEPPER_X1_SPISDO/SPI1_MISO
    { PORT_A,  7, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // STEPPER_X1_SPISDI/SPI1_MOSI
    { PORT_A,  8, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // STEPPERDRIVERCLK_X1/STEPPERDRIVERCLK_AG/MCO
    { PORT_A, 11, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // CANRXA_B/CANRX
    { PORT_A, 12, PIN_MUX_SFIO, PIN_TYP_DOUT10, PIN_OPT_NONE }, // CANTXA_B/CANTX

    { PORT_B,  0, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // X1_CURRMEASA/ADC12_IN8
    { PORT_B,  1, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // X1_CURRMEASB/ADC12_IN9
    ...
    { PORT_B, 12, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // #STEPPER_AG_SPIENABLE
    { PORT_B, 13, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // STEPPER_AG_SPISCK/SPI2_SCK
    { PORT_B, 14, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // STEPPER_AG_SPISDO/SPI2_MISO
    { PORT_B, 15, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // STEPPER_AG_SPISDI/SPI2_MOSI

    { PORT_C,  1, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // 5V_VOLTAGE_CURRENT_MEASUREMENT/ADC12_IN11
    { PORT_C,  2, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // AG_CURRMEASA/ADC12_IN12
    { PORT_C,  3, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // AG_CURRMEASB/ADC12_IN13
    ...
    { PORT_E,  0, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // AG_LIMITSWITCH1
    { PORT_E,  1, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // AG_LIMITSWITCH2
    ...
    { PORT_E,  8, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // #STEPPER_X1_CHIPENABLE
    { PORT_E,  9, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // STEPPER_X1_STALLGUARD
    { PORT_E, 10, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // STEPPER_X1_STEP
    { PORT_E, 11, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // STEPPER_X1_DIR
    { PORT_E, 12, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // #STEPPER_AG_CHIPENABLE
    { PORT_E, 13, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // STEPPER_AG_STALLGUARD
    { PORT_E, 14, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // STEPPER_AG_STEP
    { PORT_E, 15, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }  // STEPPER_AG_DIR
};
...
const halPortDescriptor_t halPortDescriptors[] = {
    ...
    { HAL_STEPPER1_ENABLE, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_E,  8, 1, 1, 0 },  // STEPPER_X1
    ...
    { HAL_STEPPER2_ENABLE, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_E, 12, 1, 1, 0 },  // STEPPER_AG
    { HAL_STEPPER2_LIMIT1, DIR_INPUT,  BUS_TYPE_INTERN, PORT_E,  0, 1, 1, 0 },
    { HAL_STEPPER2_LIMIT2, DIR_INPUT,  BUS_TYPE_INTERN, PORT_E,  1, 1, 1, 0 },
...
const halAnalogDescriptor_t halAnalogDescriptors[] = {
    ...
    { HAL_STEPPER1_PHASEA, DIR_INPUT,  BUS_TYPE_INTERN, 12,  8, 6,  3000, 0 },  // STEPPER_X1
    { HAL_STEPPER1_PHASEB, DIR_INPUT,  BUS_TYPE_INTERN, 12,  9, 6,  3000, 0 },
    { HAL_STEPPER2_PHASEA, DIR_INPUT,  BUS_TYPE_INTERN, 12, 12, 6,  3000, 0 },  // STEPPER_AG
