...
const halPortDescriptor_t halPortDescriptors[] = {
    ...
    { HAL_STEPPER1_ENABLE, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_E,  8, 1, 1, 0 }, // Stepper_Z
    { HAL_STEPPER1_LIMIT1, DIR_INPUT,  BUS_TYPE_INTERN, PORT_D, 15, 1, 1, 0 },
    { HAL_STEPPER1_LIMIT2, DIR_INPUT,  BUS_TYPE_INTERN, PORT_D, 14, 1, 1, 0 },
...
//    { HAL_STEPPER2_ENABLE, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_E, 12, 1, 1, 0 }, // Stepper_NDL
//    { HAL_STEPPER2_LIMIT1, DIR_INPUT,  BUS_TYPE_INTERN, PORT_E,  1, 1, 1, 0 },
//    { HAL_STEPPER2_LIMIT2, DIR_INPUT,  BUS_TYPE_INTERN, PORT_E,  0, 1, 1, 0 },
...
const halStepperDescriptor_t halStepperDescriptors[] = {
    { HAL_STEPPER_MOTOR_0, 0, { 0x901B4, 0xD4003, 0xE02D0, 0xA8202 }},	// Stepper_Z
    { HAL_STEPPER_MOTOR_1, 1, { 0x901B4, 0xD4003, 0xE02D0, 0xA8202 }},	// Stepper_Y
//    { HAL_STEPPER_MOTOR_1, 1, { 0x901B4, 0xD4003, 0xE02D0, 0xA8202 }},	// Stepper_NDL
};
