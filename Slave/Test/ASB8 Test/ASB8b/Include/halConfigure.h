...
#define HAL_VACUUM_PUMP         HAL_DIGITAL_OUTPUT_1
...
#define HAL_STEPPER1_PHASEA     HAL_ANALOG_INPUT_3

//! Stepper motor 1 phase B current measurement
#define HAL_STEPPER1_PHASEB     HAL_ANALOG_INPUT_4

//! Stepper motor 2 phase A current measurement
#define HAL_STEPPER2_PHASEA     HAL_ANALOG_INPUT_5

//! Stepper motor 2 phase B current measurement
#define HAL_STEPPER2_PHASEB     HAL_ANALOG_INPUT_6

//! Stepper motor 2 phase A current measurement
#define HAL_STEPPER3_PHASEA     HAL_ANALOG_INPUT_7

//! Stepper motor 2 phase B current measurement
#define HAL_STEPPER3_PHASEB     HAL_ANALOG_INPUT_8
