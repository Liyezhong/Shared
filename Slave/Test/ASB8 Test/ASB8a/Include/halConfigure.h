...
//! Laser diode select digital output
#define HAL_LASER_SELECT        HAL_DIGITAL_OUTPUT_0

//! Collector select digital output
#define HAL_COLLECT_SELECT      HAL_DIGITAL_OUTPUT_1

//! Collector voltage analog input
#define HAL_COLLECT_VOLTAGE     HAL_ANALOG_INPUT_0

//! Stepper motor 1 phase A current measurement
#define HAL_STEPPER1_PHASEA     HAL_ANALOG_INPUT_1

//! Stepper motor 1 phase B current measurement
#define HAL_STEPPER1_PHASEB     HAL_ANALOG_INPUT_2

//! Stepper motor 2 phase A current measurement
#define HAL_STEPPER2_PHASEA     HAL_ANALOG_INPUT_3

//! Stepper motor 2 phase B current measurement
#define HAL_STEPPER2_PHASEB     HAL_ANALOG_INPUT_4

//! Stepper motor 2 phase A current measurement
#define HAL_STEPPER3_PHASEA     HAL_ANALOG_INPUT_5

//! Stepper motor 2 phase B current measurement
#define HAL_STEPPER3_PHASEB     HAL_ANALOG_INPUT_6

//! PWM output controlling the laser diode
#define HAL_LASER_ENABLE        HAL_ANALOG_OUTPUT_0

//! Variable resistor amplifying the laser current
#define HAL_LASER_CURRENT       HAL_ANALOG_OUTPUT_1

//! Variable resistor amplifying slide detection signal
#define HAL_SD_VAR_RES          HAL_ANALOG_OUTPUT_2
