...
const halPinDesciptor_t halPinDescriptors[] = {
    { PORT_A,  0, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Encoder_EQEP1A/TIM2_CH1
    { PORT_A,  1, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Encoder_EQEP1B/TIM2_CH2
    { PORT_A,  2, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Encoder_EQEP1I/TIM2_CH3
    { PORT_A,  3, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Y_LimitSwitch
    { PORT_A,  4, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // #Stepper_Y_SPIEnable
    { PORT_A,  5, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // Stepper_Y_SPISCK/SPI1_SCK
    { PORT_A,  6, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Stepper_Y_SPISDO/SPI1_MISO
    { PORT_A,  7, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // Stepper_Y_SPISDI/SPI1_MOSI
    { PORT_A,  8, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // StepperDriverClk_Y/StepperDriverClk_GAB/MCO
    ...
    { PORT_B,  0, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // Distance Sensor/ADC12_IN8
    { PORT_B,  6, PIN_MUX_SFIO, PIN_TYP_DOUT10, PIN_OPT_OPENDR }, // I2C1_SCL
    { PORT_B,  7, PIN_MUX_SFIO, PIN_TYP_DOUT10, PIN_OPT_OPENDR }, // I2C1_SDA
    { PORT_B, 12, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // #Stepper_GAB_SPIEnable
    { PORT_B, 13, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // Stepper_GAB_SPISCK/SPI2_SCK
    { PORT_B, 14, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Stepper_GAB_SPISDO/SPI2_MISO
    { PORT_B, 15, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // Stepper_GAB_SPISDI/SPI2_MOSI
    ...
    { PORT_C,  2, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // Stepper_GAB_CurMeasA/ADC12_IN12
    { PORT_C,  3, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // Stepper_GAB_CurMeasB/ADC12_IN13
    { PORT_C,  4, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // UnderVoltageDetection/ADC12_IN14
    { PORT_C,  5, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // Stepper_Y_CurrMeasB/ADC12_IN15

    { PORT_D,  0, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // CAN_LBKA
    { PORT_D,  1, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // CAN_ID_4
    { PORT_D,  2, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // CAN_ID_3
    { PORT_D,  3, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // CAN_ID_2
    { PORT_D,  4, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // CAN_ID_1
    ...
    { PORT_E,  8, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // #Stepper_Y_chipEnable
    { PORT_E,  9, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Stepper_Y_StallGuard
    { PORT_E, 10, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // Stepper_Y_STEP
    { PORT_E, 11, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // Stepper_Y_DIR
    { PORT_E, 12, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // #Stepper_GAB_chipEnable
    { PORT_E, 13, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Stepper_GAB_StallGuard
    { PORT_E, 14, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // Stepper_GAB_STEP
    { PORT_E, 15, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }  // Stepper_GAB_DIR
};
...
const halPortDescriptor_t halPortDescriptors[] = {
    ...
    { HAL_STEPPER1_ENABLE, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_E,  8, 1, 1, 0 },  // STEPPER_Y
    ...
    { HAL_STEPPER2_ENABLE, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_E, 12, 1, 1, 0 },  // STEPPER_GAB
...
const halAnalogDescriptor_t halAnalogDescriptors[] = {
    ...
    { HAL_STEPPER1_PHASEA, DIR_INPUT,  BUS_TYPE_INTERN, 12, 10, 6,  3000, 0 },  // STEPPER_Y
    { HAL_STEPPER1_PHASEB, DIR_INPUT,  BUS_TYPE_INTERN, 12, 15, 6,  3000, 0 },
    { HAL_STEPPER2_PHASEA, DIR_INPUT,  BUS_TYPE_INTERN, 12, 12, 6,  3000, 0 },  // STEPPER_GAB
    { HAL_STEPPER2_PHASEB, DIR_INPUT,  BUS_TYPE_INTERN, 12, 13, 6,  3000, 0 },

    { HAL_DISTANCE_SENSOR, DIR_INPUT,  BUS_TYPE_INTERN, 12,  8, 6,  3000, 0 }
};
