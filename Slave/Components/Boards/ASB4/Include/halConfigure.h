...
//! Drawer button digital input
#define HAL_DRAWER_BUTTON   HAL_DIGITAL_INPUT_0

//! Drawer button digital output 1
#define HAL_DRAWER_LED1     HAL_DIGITAL_OUTPUT_0

//! Drawer button digital output 2
#define HAL_DRAWER_LED2     HAL_DIGITAL_OUTPUT_1

//! Stepper motor phase A current measurement
#define HAL_STEPPER1_PHASEA HAL_ANALOG_INPUT_0

//! Stepper motor phase B current measurement
#define HAL_STEPPER1_PHASEB HAL_ANALOG_INPUT_1
...
// Timer 2 programmed for quadrature encoder EQEP1
...
// Timer 4 programmed for RFID frontend (ETR as external clock)
#define TIM4_MODE_MASTER    0x4000   //!< Timer slave mode: ETR=clock input
#define TIM4_MODE_CAPCOM1   0x0000   //!< Unit 1: Disable input/output
#define TIM4_MODE_CAPCOM2   0x0000   //!< Unit 2: Disable input/output
#define TIM4_MODE_CAPCOM3   0x0103   //!< Unit 3: Demodulated data capture input
#define TIM4_MODE_CAPCOM4   0x6401   //!< Unit 4: Modulated data output (pwm)
