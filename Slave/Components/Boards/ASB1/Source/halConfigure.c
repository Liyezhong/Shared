...
const halPinDesciptor_t halPinDescriptors[] = {
    { PORT_A,  0, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // EQEP1-A
    { PORT_A,  1, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // EQEP1-B
    { PORT_A,  2, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // EQEP1-I
    ...
    { PORT_C,  0, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // AIN10/Level Sensor
    ...
    { PORT_D, 15, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // Level Sensor/Teach

    { PORT_E,  0, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // RFID RDY/CLK (T4/ETR)
    { PORT_E,  1, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // STP1/Limit2
...
const halPortDescriptor_t halPortDescriptors[] = {
    ...
    { HAL_FILL_LEVEL_TEACH, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_D, 15, 1, 0, 0 }
};
...
const halAnalogDescriptor_t halAnalogDescriptors[] = {
    ...
    { HAL_FILL_LEVEL,      DIR_INPUT, BUS_TYPE_INTERN, 12, 10, 6,  1000, 0 }
};
...
const halStepperDescriptor_t halStepperDescriptors[] = {
    { HAL_STEPPER_MOTOR_0, 0, { 0x901B4, 0xD4008, 0xE02D0, 0xA8202 }},
};
