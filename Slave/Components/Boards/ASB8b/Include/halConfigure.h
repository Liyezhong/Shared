...
//! Digital output to control air valve 1
#define HAL_AIR_VALVE_1         HAL_DIGITAL_OUTPUT_0

//! Digital output to control air valve 2
#define HAL_AIR_VALVE_2         HAL_DIGITAL_OUTPUT_1

//! Digital output to control vacuum pump
#define HAL_VACUUM_PUMP         HAL_DIGITAL_OUTPUT_2

//! Hall sensor analog input
#define HAL_HALL_SENSOR         HAL_ANALOG_INPUT_0

//! Pressure sensor analog input
#define HAL_PRESSURE_SENSOR     HAL_ANALOG_INPUT_1
...
#define HAL_STEPPER2_PHASEA     HAL_ANALOG_INPUT_4

//! Stepper motor 2 phase B current measurement
#define HAL_STEPPER2_PHASEB     HAL_ANALOG_INPUT_5

//! Stepper motor 3 phase A current measurement
#define HAL_STEPPER3_PHASEA     HAL_ANALOG_INPUT_6

//! Stepper motor 3 phase B current measurement
#define HAL_STEPPER3_PHASEB     HAL_ANALOG_INPUT_7
