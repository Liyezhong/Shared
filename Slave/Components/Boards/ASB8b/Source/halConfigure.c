...
const halPinDesciptor_t halPinDescriptors[] = {
    { PORT_A,  0, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Encoder_Y_EQEP1A/TIM2_CH1
    { PORT_A,  1, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Encoder_Y_EQEP1B/TIM2_CH2
    { PORT_A,  2, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Encoder_Y_EQEP1I/TIM2_CH3
    { PORT_A,  3, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // HallSensor/ADC12_IN3
    { PORT_A,  4, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // #Stepper_Z_SPIEnable
    { PORT_A,  5, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // Stepper_Z_SPISCK
    { PORT_A,  6, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Stepper_Z_SPISDO
    { PORT_A,  7, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // Stepper_Z_SPISDI
    { PORT_A,  8, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // StepperDriverClk_Y/StepperDriverClk_Z/StepperDriverClk_NDL/MCO
    ...
    { PORT_B,  0, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // Stepper_NDL_CurMeasA/ADC12_IN8
    { PORT_B,  1, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // Stepper_NDL_CurMeasB/ADC12_IN9
    { PORT_B,  6, PIN_MUX_SFIO, PIN_TYP_DOUT10, PIN_OPT_OPENDR }, // I2C1_SCL
    { PORT_B,  7, PIN_MUX_SFIO, PIN_TYP_DOUT10, PIN_OPT_OPENDR }, // I2C1_SDA
    { PORT_B, 13, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // Stepper_NDL_SPISCK/Stepper_Y_SPISCK/SPI2_SCK
    { PORT_B, 14, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Stepper_NDL_SPISDO/Stepper_Y_SPISDO/SPI2_MISO
    { PORT_B, 15, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // Stepper_NDL_SPISDI/Stepper_Y_SPISDI/SPI2_MOSI

    { PORT_C,  0, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // Stepper_Y_CurrMeasA/ADC12_IN10
    { PORT_C,  1, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // Stepper_Y_CurrMeasB/ADC12_IN11
    { PORT_C,  2, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // Stepper_Z_CurrMeasA/ADC12_IN12
    { PORT_C,  3, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // Stepper_Z_CurrMeasB/ADC12_IN13
    { PORT_C,  4, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // UnderVoltageDetection/ADC12_IN14
    { PORT_C,  5, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // PressureSensor/ADC12_IN15
    { PORT_C,  6, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // #Stepper_Y_SPIEnable
    { PORT_C,  7, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // #Stepper_NDL_SPIEnable

    { PORT_D,  0, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // CAN_LBKB
    { PORT_D,  1, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // CAN_ID_4B
    { PORT_D,  2, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // CAN_ID_3B
    { PORT_D,  3, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // CAN_ID_2B
    { PORT_D,  4, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // CAN_ID_1B
    { PORT_D,  5, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // #Stepper_Y_chipEnable
    { PORT_D,  6, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Stepper_Y_StallGuard
    { PORT_D,  7, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // Stepper_Y_STEP
    { PORT_D,  8, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // Stepper_Y_DIR
    { PORT_D, 10, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // AirValveControl1
    { PORT_D, 11, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // AirValveControl2
    { PORT_D, 12, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // VacuumPumpControl
    { PORT_D, 13, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // LimitSwitch_Y
    { PORT_D, 14, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // LimitSwitch2_Z
    { PORT_D, 15, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // LimitSwitch1_Z

    { PORT_E,  0, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // LimitSwitch2_NDL
    { PORT_E,  1, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // LimitSwitch1_NDL
    ...
    { PORT_E,  8, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // #Stepper_Z_chipEnable
    { PORT_E,  9, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Stepper_Z_StallGuard
    { PORT_E, 10, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // Stepper_Z_STEP
    { PORT_E, 11, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // Stepper_Z_DIR
    { PORT_E, 12, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // #Stepper_NDL_chipEnable
    { PORT_E, 13, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Stepper_NDL_StallGuard
    { PORT_E, 14, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // Stepper_NDL_STEP
    { PORT_E, 15, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }  // Stepper_NDL_DIR
};
...
const halPortDescriptor_t halPortDescriptors[] = {
    ...
    { HAL_STEPPER1_ENABLE, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_E, 12, 1, 1, 0 }, // Stepper_NDL
    { HAL_STEPPER1_LIMIT1, DIR_INPUT,  BUS_TYPE_INTERN, PORT_E,  1, 1, 1, 0 },
    { HAL_STEPPER1_LIMIT2, DIR_INPUT,  BUS_TYPE_INTERN, PORT_E,  0, 1, 1, 0 },
    { HAL_STEPPER1_SELECT, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_C,  7, 1, 0, 0 },
    
    { HAL_STEPPER2_ENABLE, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_D,  5, 1, 1, 0 }, // Stepper_Y
    { HAL_STEPPER2_LIMIT1, DIR_INPUT,  BUS_TYPE_INTERN, PORT_D, 13, 1, 1, 0 },
    { HAL_STEPPER2_SELECT, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_C,  6, 1, 0, 0 },
    
    { HAL_STEPPER3_ENABLE, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_E,  8, 1, 1, 0 }, // Stepper_Z
    { HAL_STEPPER3_LIMIT1, DIR_INPUT,  BUS_TYPE_INTERN, PORT_D, 15, 1, 1, 0 },
    { HAL_STEPPER3_LIMIT2, DIR_INPUT,  BUS_TYPE_INTERN, PORT_D, 14, 1, 1, 0 },
    { HAL_STEPPER3_SELECT, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_A,  4, 1, 0, 0 },

    { HAL_AIR_VALVE_1,     DIR_OUTPUT, BUS_TYPE_INTERN, PORT_D, 10, 1, 0, 0 },
    { HAL_AIR_VALVE_2,     DIR_OUTPUT, BUS_TYPE_INTERN, PORT_D, 11, 1, 0, 0 },
    { HAL_VACUUM_PUMP,     DIR_OUTPUT, BUS_TYPE_INTERN, PORT_D, 12, 1, 0, 0 }
};
...
const halAnalogDescriptor_t halAnalogDescriptors[] = {
    ...
    { HAL_HALL_SENSOR,     DIR_INPUT,  BUS_TYPE_INTERN, 12,  3, 6,  3000, 0 },
    { HAL_PRESSURE_SENSOR, DIR_INPUT,  BUS_TYPE_INTERN, 12, 15, 6,  3000, 0 },
    
    { HAL_STEPPER1_PHASEA, DIR_INPUT,  BUS_TYPE_INTERN, 12,  8, 6,  3000, 0 },   // Stepper_NDL
    { HAL_STEPPER1_PHASEB, DIR_INPUT,  BUS_TYPE_INTERN, 12,  9, 6,  3000, 0 },
    { HAL_STEPPER2_PHASEA, DIR_INPUT,  BUS_TYPE_INTERN, 12, 10, 6,  3000, 0 },   // Stepper_Y
    { HAL_STEPPER2_PHASEB, DIR_INPUT,  BUS_TYPE_INTERN, 12, 11, 6,  3000, 0 },
    { HAL_STEPPER3_PHASEA, DIR_INPUT,  BUS_TYPE_INTERN, 12, 12, 6,  3000, 0 },   // Stepper_Z
    { HAL_STEPPER3_PHASEB, DIR_INPUT,  BUS_TYPE_INTERN, 12, 13, 6,  3000, 0 },
};
...
const halTimerDescriptor_t halTimerDescriptors[] = {
    ...
    // Timer 2 programmed as quadrature encoder with index input (Encoder_Y_EQEP1)
...
const halStepperDescriptor_t halStepperDescriptors[] = {
    { HAL_STEPPER_MOTOR_0, 1, { 0x901B4, 0xD4003, 0xE02D0, 0xA8202 }},
    { HAL_STEPPER_MOTOR_1, 1, { 0x901B4, 0xD4003, 0xE02D0, 0xA8202 }},
    { HAL_STEPPER_MOTOR_2, 0, { 0x901B4, 0xD4003, 0xE02D0, 0xA8202 }},
};
