...
const halPortDescriptor_t halPortDescriptors[] = {
    ...
    { HAL_STEPPER1_ENABLE, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_E,  8, 1, 1, 0 }, // Stepper_CLP
    { HAL_STEPPER1_LIMIT1, DIR_INPUT,  BUS_TYPE_INTERN, PORT_D, 11, 1, 1, 0 },
    ...
    { HAL_STEPPER3_ENABLE, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_E, 12, 1, 1, 0 }, // Stepper_SFT
    { HAL_STEPPER3_LIMIT1, DIR_INPUT,  BUS_TYPE_INTERN, PORT_C, 12, 1, 1, 0 },
    { HAL_STEPPER3_SELECT, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_C,  8, 1, 0, 0 },
...
const halAnalogDescriptor_t halAnalogDescriptors[] = {
    { HAL_SUPPLY_VOLTAGE,  DIR_INPUT,  BUS_TYPE_INTERN, 12, 14, 3, 30000, 0 },
    { HAL_SUPPLY_CURRENT,  DIR_INPUT,  BUS_TYPE_INTERN, 12, 11, 3,   750, 0 },
    { HAL_COLLECT_VOLTAGE, DIR_INPUT,  BUS_TYPE_INTERN, 12, 10, 3,  3000, 0 },
    
    { HAL_STEPPER1_PHASEA, DIR_INPUT,  BUS_TYPE_INTERN, 12,  8, 3,  3000, 0 },   // Stepper_CLP
    { HAL_STEPPER1_PHASEB, DIR_INPUT,  BUS_TYPE_INTERN, 12,  9, 3,  3000, 0 },
    { HAL_STEPPER2_PHASEA, DIR_INPUT,  BUS_TYPE_INTERN, 12, 12, 3,  3000, 0 },   // Stepper_ELVT
    { HAL_STEPPER2_PHASEB, DIR_INPUT,  BUS_TYPE_INTERN, 12, 13, 3,  3000, 0 },
