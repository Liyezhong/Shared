...
static const bmModuleParameters_t ModuleInitTable[] = {
    { MODULE_ID_DIGITAL_OUT, 2, doInitializeModule },
    { MODULE_ID_ANALOG_IN,   7, aiInitializeModule }, 
    { MODULE_ID_ANALOG_OUT,  3, aoInitializeModule },
    { MODULE_ID_STEPPER,     3, smInitializeModule },
};
...
static Error_t InitTestBoardInfoBlock (void) {
    ...
    InfoBlock.NodeType        = 8;
    InfoBlock.NodeClass       = 0;

    strcpy (InfoBlock.BoardName, "ASB8a");
