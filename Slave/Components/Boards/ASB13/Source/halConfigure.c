...
const halPinDesciptor_t halPinDescriptors[] = {
    { PORT_A,  0, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Encoder_EQEP1A/TIM2_CH1_ETR
    ...
    { PORT_A,  4, PIN_MUX_GPIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // #Stepper_SPIEnable
    { PORT_A,  5, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // Stepper_SPISCK/SPI1_SCK
    { PORT_A,  6, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // Stepper_SPISDO/SPI1_MISO
    { PORT_A,  7, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // Stepper_SPISDI/SPI1_MOSI
    { PORT_A,  8, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // StepperDriverClk/MCO
    { PORT_A, 11, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // CANRXA/CANRX
    { PORT_A, 12, PIN_MUX_SFIO, PIN_TYP_DOUT10, PIN_OPT_NONE }, // CANRXB/CANTX

    { PORT_B,  5, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // RFID_EN
    { PORT_B,  6, PIN_MUX_SFIO, PIN_TYP_DOUT10, PIN_OPT_OPENDR }, // I2C2/I2C1_SCL
    { PORT_B,  7, PIN_MUX_SFIO, PIN_TYP_DOUT10, PIN_OPT_OPENDR }, // I2C2/I2C1_SDA
    { PORT_B,  8, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // RFID_DOUT/TIM4_CH3
    { PORT_B, 14, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // RDID_DIN
    { PORT_B, 15, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // RDID_DCLK

    { PORT_C,  1, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // 5V_voltage_current_measurement/ADC12_IN11
    { PORT_C,  2, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // Stepper_CurrMeasA/ADC12_IN12
    { PORT_C,  3, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // Stepper_CurrMeasB/ADC12_IN13
    { PORT_C,  4, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // UnderVoltageDetection/ADC12_IN14

    { PORT_D,  0, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // CANLBKA
    ...
    { PORT_E,  0, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // RFID_DOUT1/TIM4_ETR
    { PORT_E,  1, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // LimitSwitch2
    ...
    { PORT_E, 15, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }  // Stepper_DIR
};
...
const halPortDescriptor_t halPortDescriptors[] = {
    ...
    { HAL_STEPPER1_LIMIT2,  DIR_INPUT,  BUS_TYPE_INTERN, PORT_E,  1, 1, 1, 0 },
    { HAL_STEPPER1_SELECT,  DIR_OUTPUT, BUS_TYPE_INTERN, PORT_A,  4, 1, 0, 0 },

    { HAL_RFID15693_EN,     DIR_OUTPUT, BUS_TYPE_INTERN, PORT_B,  5, 1, 0, 0 },
    { HAL_RFID15693_OUT,    DIR_OUTPUT, BUS_TYPE_INTERN, PORT_B, 14, 2, 0, 0 }
};
...
const halTimerDescriptor_t halTimerDescriptors[] = {
    ...
    { HAL_RFID15693_TIM_0,  3, 0, 3, TIM_SEL_COUNTER, TIM4_MODE_MASTER  },
    { HAL_RFID15693_TIM_0,  3, 0, 0, TIM_SEL_DISABLE, TIM4_MODE_CAPCOM1 },
    { HAL_RFID15693_TIM_0,  3, 1, 0, TIM_SEL_DISABLE, TIM4_MODE_CAPCOM2 },
    { HAL_RFID15693_TIM_0,  3, 2, 0, TIM_SEL_CAPTURE, TIM4_MODE_CAPCOM3 },
    { HAL_RFID15693_TIM_0,  3, 3, 0, TIM_SEL_COMPARE, TIM4_MODE_CAPCOM4 },
};
