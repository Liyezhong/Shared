...
const halPinDesciptor_t halPinDescriptors[] = {
    { PORT_A,  0, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // ENCODER_X2_EQEP1A/TIM2_CH1
    { PORT_A,  1, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // ENCODER_X2_EQEP1B/TIM2_CH2
    { PORT_A,  2, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // ENCODER_X2_EQEP1I/TIM2_CH3
    { PORT_A,  3, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // X2_LIMITSWITCH
    { PORT_A,  4, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // #STEPPER_X2_SPIENABLE
    { PORT_A,  5, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // STEPPER_X2_SPISCK/SPI1_SCK
    { PORT_A,  6, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // STEPPER_X2_SPISDO/SPI1_MISO
    { PORT_A,  7, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // STEPPER_X2_SPISDI/SPI1_MOSI
    { PORT_A,  8, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // STEPPERDRIVERCLK_X2/MCO
    { PORT_A, 11, PIN_MUX_SFIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // CANRXA_A/CANRX
    { PORT_A, 12, PIN_MUX_SFIO, PIN_TYP_DOUT10, PIN_OPT_NONE }, // CANTXA_A/CANTX

    { PORT_B, 10, PIN_MUX_SFIO, PIN_TYP_DOUT10, PIN_OPT_OPENDR }, // I2C2_SCL
    { PORT_B, 11, PIN_MUX_SFIO, PIN_TYP_DOUT10, PIN_OPT_OPENDR }, // I2C2_SDA

    { PORT_C,  0, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // X2_CURRMEASA/ADC12_IN10
    { PORT_C,  1, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // X2_CURRMEASB/ADC12_IN11
    { PORT_C,  2, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // EXHAUSTAIRFAN2_CURRENTMEAS/ADC12_IN12
    { PORT_C,  3, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // EXHAUSTAIRFAN1_CURRENTMEAS/ADC12_IN13
    { PORT_C,  4, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // UNDERVOLTAGEDETECTION1/ADC12_IN14
    { PORT_C,  5, PIN_MUX_SFIO, PIN_TYP_ANALOG, PIN_OPT_NONE }, // UNDERVOLTAGEDETECTION2/ADC12_IN15

    { PORT_D,  0, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // CAN_LBKA_A
    { PORT_D,  1, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // CAN_ID_4A
    { PORT_D,  2, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // CAN_ID_3A
    { PORT_D,  3, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // CAN_ID_2A
    { PORT_D,  4, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // CAN_ID_1A
    { PORT_D,  5, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // EXHAUSTAIRFAN1_CONTROL
    { PORT_D,  6, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // EXHAUSTAIRFAN2_CONTROL
    { PORT_D,  7, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // LIGHT_CONTROL
    { PORT_D, 10, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // WATERVALVECONTROL1
    { PORT_D, 11, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // WATERVALVECONTROL2
    { PORT_D, 12, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // WATERVALVECONTROL3
    { PORT_D, 13, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // WATERVALVECONTROL4
    { PORT_D, 14, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // WATERVALVECONTROL5
    { PORT_D, 15, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // WATERVALVECONTROL6

    { PORT_E,  0, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // AIRFLOWSWITCH
    { PORT_E,  1, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // LEVELSWITCH
    ...
    { PORT_E,  7, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // REEDRELAYACTIVE
    { PORT_E, 12, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // #STEPPER_X2_CHIPENABLE
    { PORT_E, 13, PIN_MUX_GPIO, PIN_TYP_DINPUT, PIN_OPT_NONE }, // STEPPER_X2_STALLGUARD
    { PORT_E, 14, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // STEPPER_X2_STEP
    { PORT_E, 15, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }  // STEPPER_X2_DIR
};
...
const halPortDescriptor_t halPortDescriptors[] = {
    ...
    { HAL_AIRFAN_CONTROL1, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_D,  5, 1, 0, 0 },
    { HAL_AIRFAN_CONTROL2, DIR_OUTPUT, BUS_TYPE_INTERN, PORT_D,  6, 1, 0, 0 },
    { HAL_LIGHT_CONTROL,   DIR_OUTPUT, BUS_TYPE_INTERN, PORT_D,  7, 1, 0, 0 },
    { HAL_VALVE_CONTROL1,  DIR_OUTPUT, BUS_TYPE_INTERN, PORT_D, 10, 1, 0, 0 },
    { HAL_VALVE_CONTROL2,  DIR_OUTPUT, BUS_TYPE_INTERN, PORT_D, 11, 1, 0, 0 },
    { HAL_VALVE_CONTROL3,  DIR_OUTPUT, BUS_TYPE_INTERN, PORT_D, 12, 1, 0, 0 },
    { HAL_VALVE_CONTROL4,  DIR_OUTPUT, BUS_TYPE_INTERN, PORT_D, 13, 1, 0, 0 },
    { HAL_VALVE_CONTROL5,  DIR_OUTPUT, BUS_TYPE_INTERN, PORT_D, 14, 1, 0, 0 },
    { HAL_VALVE_CONTROL6,  DIR_OUTPUT, BUS_TYPE_INTERN, PORT_D, 15, 1, 0, 0 },
    
    { HAL_AIRFLOW_SWITCH,  DIR_INPUT,  BUS_TYPE_INTERN, PORT_E,  0, 1, 0, 0 },
    { HAL_LEVEL_SWITCH,    DIR_INPUT,  BUS_TYPE_INTERN, PORT_E,  1, 1, 0, 0 },
    { HAL_REED_ACTIVE,     DIR_INPUT,  BUS_TYPE_INTERN, PORT_E,  7, 1, 0, 0 }
};
...
const halTimerDescriptor_t halTimerDescriptors[] = {
    ...
    // Timer 2 programmed as quadrature encoder with index input
