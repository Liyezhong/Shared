...
static const bmModuleParameters_t ModuleInitTable[] = {
    { MODULE_ID_DIGITAL_IN,  3, diInitializeModule },
    { MODULE_ID_DIGITAL_OUT, 9, doInitializeModule },
    { MODULE_ID_ANALOG_IN,   4, aiInitializeModule }, 
...
static Error_t InitTestBoardInfoBlock (void) {
    ...
    InfoBlock.NodeType        = 0x06;
    InfoBlock.NodeClass       = 0;

    strcpy (InfoBlock.BoardName, "SABa");
