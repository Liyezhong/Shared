...
#define DEFAULT_NODE_INDEX      2       //!< Node index (if no DIP switch)
...
#define CURRENT_LIMIT_WARNING   1000    //!< Supply current warning limit [mA]
#define CURRENT_LIMIT_FAILURE   2000    //!< Supply current error limit [mA]
...
static const bmModuleParameters_t ModuleInitTable[] = {
  ...
  //{ MODULE_ID_RFID11785,   1, rfid11785InitializeModule },
  //{ MODULE_ID_RFID15693,   1, rfid15693InitializeModule },
...
static Error_t InitTestBoardInfoBlock (void) {
    ...
    InfoBlock.NodeType        = 0x33;
    InfoBlock.NodeClass       = 0;

    strcpy (InfoBlock.BoardName, "EVAL");
