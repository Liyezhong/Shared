...
#define PROCESSOR     STM32F103xE   //!< Define processor type
...
// Timer 1 programmed for quadrature encoder
#define TIM1_MODE_MASTER   0x0000  //!< Timer 1 slave mode (SMC)
//#define TIM1_MODE_CAPCOM1  0xA101  //!< Timer 1 capture/compare 1 mode
//#define TIM1_MODE_CAPCOM2  0xA103  //!< Timer 1 capture/compare 2 mode
#define TIM1_MODE_CAPCOM1  0x0000  //!< Timer 1 capture/compare 1 mode
#define TIM1_MODE_CAPCOM2  0x0000  //!< Timer 1 capture/compare 2 mode
#define TIM1_MODE_CAPCOM3  0x0000  //!< Timer 1 capture/compare 3 mode
#define TIM1_MODE_CAPCOM4  0x0000  //!< Timer 1 capture/compare 4 mode

// Timer 2 programmed for compare outputs (4 channels)
#define TIM2_MODE_MASTER   0x0000  //!< Timer 1 slave mode (SMC)
#define TIM2_MODE_CAPCOM1  0x6C01  //!< Timer 1 capture/compare 1 mode
#define TIM2_MODE_CAPCOM2  0x6C01  //!< Timer 1 capture/compare 2 mode
#define TIM2_MODE_CAPCOM3  0x6C01  //!< Timer 1 capture/compare 3 mode
#define TIM2_MODE_CAPCOM4  0x6C01  //!< Timer 1 capture/compare 4 mode

// Timer 3 programmed for PWM output (4 channels)
#define TIM3_MODE_MASTER   0x0000  //!< Timer 1 slave mode (SMC)
#define TIM3_MODE_CAPCOM1  0x6C01  //!< Timer 1 capture/compare 1 mode
#define TIM3_MODE_CAPCOM2  0x6C01  //!< Timer 1 capture/compare 2 mode
#define TIM3_MODE_CAPCOM3  0x6C01  //!< Timer 1 capture/compare 3 mode
#define TIM3_MODE_CAPCOM4  0x6C01  //!< Timer 1 capture/compare 4 mode

// Timer 4 programmed for channels unused
#define TIM4_MODE_MASTER   0x0000  //!< Timer 1 slave mode (SMC)
#define TIM4_MODE_CAPCOM1  0x6C01  //!< Timer 1 capture/compare 1 mode
#define TIM4_MODE_CAPCOM2  0x6C01  //!< Timer 1 capture/compare 2 mode
#define TIM4_MODE_CAPCOM3  0x6C01  //!< Timer 1 capture/compare 3 mode
#define TIM4_MODE_CAPCOM4  0x6C01  //!< Timer 1 capture/compare 4 mode
...
//  --------------------------------------
//
#define MAPPING_CAN1     2   //!< Configured CAN 1 pin mapping
