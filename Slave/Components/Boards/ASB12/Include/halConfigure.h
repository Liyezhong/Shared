...
//! Camera shot activation signal
#define HAL_CAMERA_SIGNAL       HAL_DIGITAL_OUTPUT_0

//! PWM output controlling the photo electric transmitter
#define HAL_TRANSMIT_CONTROL    HAL_ANALOG_OUTPUT_0

//! Variable resistor amplifying the photo electric transmitter current
#define HAL_TRANSMIT_CURRENT    HAL_ANALOG_OUTPUT_1

//! Variable resistor amplifying the photo electric receiver current
#define HAL_RECEIVE_CURRENT     HAL_ANALOG_OUTPUT_2

//! Analog value from the photo electric detector
#define HAL_PHOTO_ELECTRIC      HAL_ANALOG_INPUT_0
