...
const halPinDesciptor_t halPinDescriptors[] = {
    { PORT_A,  4, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // PhotoElectricTransmitterCurrent_SPI#CS
    { PORT_A,  5, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // PhotoElectricTransmitterCurrent_SPICLK (SPI1_SCK)
    { PORT_A,  7, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // PhotoElectricTransmitterCurrent_SPIDI (SPI1_MOSI)
    ...
    { PORT_B,  8, PIN_MUX_SFIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // PhotoElectricTransmitterControl (TIM4_CH3)
    { PORT_B, 12, PIN_MUX_GPIO, PIN_TYP_DOUT2,  PIN_OPT_NONE }, // Receiver_VarRes_SPI#CS
    { PORT_B, 13, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // Receiver_VarRes_SPICLK (SPI2_SCK)
    { PORT_B, 15, PIN_MUX_SFIO, PIN_TYP_DOUT50, PIN_OPT_NONE }, // Receiver_VarRes_SPISDI (SPI2_MOSI)
...
const halPortDescriptor_t halPortDescriptors[] = {
    ...
    { HAL_SPI_SELECT_0,   DIR_OUTPUT, BUS_TYPE_INTERN, PORT_A,  4, 1, 0, 0 },
    { HAL_SPI_SELECT_1,   DIR_OUTPUT, BUS_TYPE_INTERN, PORT_B, 12, 1, 0, 0 },
};
 ...
 *      - Conversion time
 *      - Scaling facor (value for full scale) / PWM: period in multiples of 10 ns
 *      - Initial output value
 *      - Device ID of the underlying I/O (only for PWM, SPI)
 *
 ***********************************************************************************/
...
const halAnalogDescriptor_t halAnalogDescriptors[] = {
    ...
    { HAL_TRANSMIT_CURRENT, DIR_OUTPUT, BUS_TYPE_SPI,     8,  0, 0,     1, 0xFF,   HAL_BUS_SPI_A },
    { HAL_RECEIVE_CURRENT,  DIR_OUTPUT, BUS_TYPE_SPI,     8,  0, 0,     1, 0,      HAL_BUS_SPI_B },
};
...
const halSerialDescriptor_t halSerialDescriptors[] = {
    ...
    { HAL_BUS_SPI_A,  HAL_SPI_SELECT_0, SIO_TYPE_SPI, 1, 0, 4500000 },
    { HAL_BUS_SPI_B,  HAL_SPI_SELECT_1, SIO_TYPE_SPI, 1, 1, 4500000 }
};
