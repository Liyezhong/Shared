...
static const bmCanIdNames_t CanIdNames[] = {
    ...
    { MSG_AO_SRV_STATISTICS,     "MSG_AO_SRV_STATISTICS"     },
    { MSG_AO_SRV_CFG_STATISTICS, "MSG_AO_SRV_CFG_STATISTICS" },
    { MSG_AO_SRV_REQ_RESET_DATA, "MSG_AO_SRV_REQ_RESET_DATA" },
    { MSG_AO_SRV_ACK_RESET_DATA, "MSG_AO_SRV_ACK_RESET_DATA" },

    { MSG_AO_PROC_CONFIGURE,     "MSG_AO_PROC_CONFIGURE"     },
    { MSG_AO_PROC_REQ_DATA,      "MSG_AO_PROC_REQ_DATA"      },
    { MSG_AO_PROC_DATA,          "MSG_AO_PROC_DATA"          },

    { MSG_AO_EVENT_INFO,         "MSG_AO_EVENT_INFO"         },
    { MSG_AO_EVENT_WARNING,      "MSG_AO_EVENT_WARNING"      },
    { MSG_AO_EVENT_ERROR,        "MSG_AO_EVENT_ERROR"        },
    { MSG_AO_EVENT_FATAL,        "MSG_AO_EVENT_FATAL"        },

    { MSG_AO_CONFIG_OUTPUT,      "MSG_AO_CONFIG_OUTPUT"      },
    { MSG_AO_SET_OUTPUT_STATE,   "MSG_AO_SET_OUTPUT_STATE"   },
    { MSG_AO_REQ_OUTPUT_STATE,   "MSG_AO_REQ_OUTPUT_STATE"   },
    { MSG_AO_OUTPUT_STATE,       "MSG_AO_OUTPUT_STATE"       },
    { MSG_AO_REQ_LIFETIME_DATA,  "MSG_AO_REQ_LIFETIME_DATA"  },
    { MSG_AO_LIFETIME_DATA,      "MSG_AO_LIFETIME_DATA"      }
};
