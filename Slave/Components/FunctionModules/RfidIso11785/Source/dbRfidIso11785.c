...
static const bmCanIdNames_t CanIdNames[] = {
    ...
    { MSG_SRV_STATISTICS,       "MSG_RFID11785_SRV_STATISTICS"     },
    { MSG_SRV_CFG_STATISTICS,   "MSG_RFID11785_SRV_CFG_STATISTICS" },
    { MSG_SRV_REQ_RESET_DATA,   "MSG_RFID11785_SRV_REQ_RESET_DATA" },
    { MSG_SRV_ACK_RESET_DATA,   "MSG_RFID11785_SRV_ACK_RESET_DATA" },

    { MSG_PROC_CONFIGURE,       "MSG_RFID11785_PROC_CONFIGURE"     },
    { MSG_PROC_REQ_DATA,        "MSG_RFID11785_PROC_REQ_DATA"      },
    { MSG_PROC_DATA,            "MSG_RFID11785_PROC_DATA"          },

    { MSG_EVENT_INFO,           "MSG_RFID11785_EVENT_INFO"         },
    { MSG_EVENT_WARNING,        "MSG_RFID11785_EVENT_WARNING"      },
    { MSG_EVENT_ERROR,          "MSG_RFID11785_EVENT_ERROR"        },
    { MSG_EVENT_FATAL,          "MSG_RFID11785_EVENT_FATAL"        },

    { MSG_RFID11785_SET_CONFIG,      "MSG_RFID11785_SET_CONFIG"      },
    { MSG_RFID11785_SEND_LOGIN,      "MSG_RFID11785_SEND_LOGIN"      },
    { MSG_RFID11785_WRITE_USER_DATA, "MSG_RFID11785_WRITE_USER_DATA" },
...
static const ErrorString_t EventNames[] = {
    { E_RFID11785_TRANSACTION_ACTIVE,  "RFID transaction in progress"    },
    { E_RFID11785_ERROR_PATTERN,       "Transmission to RFID tag failed" },
    { E_RFID11785_UNKNOWN_PATTERN,     "Reception from RFID tag failed"  },
    { E_RFID11785_PARITY_ERROR,        "Parity error in a read response" },
    { E_RFID11785_TRANSACTION_TIMEOUT, "RFID transaction timeout"        }
};
