/****************************************************************************/
/*! \file fmStepperMotorMotionISR.h
 * 
...
//! minimal stepper timer interrupt interval time in µsec, at which step loss can be processed
#define ISR_ENCODER_TIME_LIMIT              100
...
void smTestISR (UInt32 UserTag, UInt32 IntrFlags);
