...
#define SM_PROFILE_MICROSTEPS_PER_HALFSTEP  1                                       //!< step unit used for precalculation of phase data
#define SM_PROFILE_TIMEBASE                 MSEC                                    //!< time unit used for precalculation of phase data

#define SM_START_HSTEPS                     5 * SM_PROFILE_MICROSTEPS_PER_HALFSTEP  //!< amount of half-step used for phase 0 (motor start with constant speed)
#define SM_END_HSTEPS                       5 * SM_PROFILE_MICROSTEPS_PER_HALFSTEP  //!< amount of half-step used for phase 8 (motor run with constant speed and then stop)
