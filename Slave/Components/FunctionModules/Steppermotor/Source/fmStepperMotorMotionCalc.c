...
{
    PhData_T->s = PhData_0->s + PhData_0->v*dt/SM_PROFILE_TIMEBASE + a*dt*dt/2/SM_PROFILE_TIMEBASE/SM_PROFILE_TIMEBASE;
    PhData_T->v = PhData_0->v + a*dt/SM_PROFILE_TIMEBASE;
    PhData_T->a = a;
    PhData_T->t = PhData_0->t + dt;
...
{
    PhData_T->s = PhData_0->s + PhData_0->v*dt/SM_PROFILE_TIMEBASE + PhData_0->a*dt*dt/2/SM_PROFILE_TIMEBASE/SM_PROFILE_TIMEBASE + j*dt/SM_PROFILE_TIMEBASE*dt/SM_PROFILE_TIMEBASE*dt/SM_PROFILE_TIMEBASE/6;

    PhData_T->v = PhData_0->v + PhData_0->a*dt/SM_PROFILE_TIMEBASE + j*dt*dt/2/SM_PROFILE_TIMEBASE/SM_PROFILE_TIMEBASE;
    PhData_T->a = PhData_0->a + j*dt/SM_PROFILE_TIMEBASE;
    PhData_T->t = PhData_0->t + dt;
    PhData_0->ds = PhData_T->s - PhData_0->s;
    PhData_0->dv = PhData_T->v - PhData_0->v;
    PhData_0->da = PhData_T->a - PhData_0->a;
...
{
    Int32 v0 = vT - a*t/SM_PROFILE_TIMEBASE - j*t*t/2/SM_PROFILE_TIMEBASE/SM_PROFILE_TIMEBASE;
...
Int32 smCalcAccPhaseData (Int32 DistanceConstVel, smProfileConfig_t *Config, smPhaseData_t *PhaseData, Bool UseJerk)
{
    ...
    // increasing acceleration jerk
        smCalcJerk (&PhaseData[PH_1_ACC_JERK_UP], &PhaseData[PH_2_ACC_CONST], (Int64)Config->acc*SM_PROFILE_TIMEBASE/Config->accJUpT, Config->accJUpT);
    ...
    // calculate velocity at start of decreasing acceleration jerk to know the duration
        PhaseData[PH_3_ACC_JERK_DOWN].v = smCalcJerk_v0 (Config->vMax, Config->accJDownT, Config->acc, (Int64)-Config->acc*SM_PROFILE_TIMEBASE/Config->accJDownT);
        if (PhaseData[PH_3_ACC_JERK_DOWN].v < PhaseData[PH_2_ACC_CONST].v) {
            return -1;
        }
        dt_constAcc = (Int64)(PhaseData[PH_3_ACC_JERK_DOWN].v-PhaseData[PH_2_ACC_CONST].v)*SM_PROFILE_TIMEBASE/Config->acc;
    ...
    // constant acceleration
        ...
        smCalcJerk (&PhaseData[PH_3_ACC_JERK_DOWN], &PhaseData[PH_4_VEL_CONST], (Int64)-Config->acc*SM_PROFILE_TIMEBASE/Config->accJDownT, Config->accJDownT);
...
Int32 smCalcDecPhaseData (smProfileConfig_t *Config, smPhaseData_t *PhaseData, Bool UseJerk)
{
    ...
    {
        smCalcJerk (&PhaseData[PH_5_DEC_JERK_UP], &PhaseData[PH_6_DEC_CONST], (Int64)-Config->dec*SM_PROFILE_TIMEBASE/Config->decJUpT, Config->decJUpT);
    ...
    // calculate velocity at start of decreasing deceleration jerk to know the duration
        PhaseData[PH_7_DEC_JERK_DOWN].v = smCalcJerk_v0 (Config->vMin, Config->decJDownT, -Config->dec, (Int64)Config->dec*SM_PROFILE_TIMEBASE/Config->decJDownT);
        if (PhaseData[PH_7_DEC_JERK_DOWN].v > PhaseData[PH_6_DEC_CONST].v) {
            return -1;
        }
        dt_constDec = (Int64)(PhaseData[PH_6_DEC_CONST].v-PhaseData[PH_7_DEC_JERK_DOWN].v)*SM_PROFILE_TIMEBASE/Config->dec;
        ...
        smCalcJerk (&PhaseData[PH_7_DEC_JERK_DOWN], &PhaseData[PH_8_END], (Int64)Config->dec*SM_PROFILE_TIMEBASE/Config->decJDownT, Config->decJDownT);
