...
//! Builds the CAN ID from the command class, the command code and the master/slave bit
...
#define MSG_SRV_REQ_MODULE_SERIAL   BUILD_CAN_ID(CMD_CLASS_SERVICE, 23, 1)
#define MSG_SRV_MODULE_SERIAL       BUILD_CAN_ID(CMD_CLASS_SERVICE, 23, 0)
#define MSG_SRV_SET_MODULE_SERIAL   BUILD_CAN_ID(CMD_CLASS_SERVICE, 24, 1)
