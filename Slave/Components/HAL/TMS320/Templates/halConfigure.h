...
#define PLL_CLOCK_MULIPLIER     7   //!< VCO: 30MHz * 7 = 210 MHz
#define PLL_CLOCK_DIVIDER       2   //!< CLK: 210MZh / 2 = 105 MHz

#define HiSPEED_CLOCK_DIVIDER   1   //!< HSCLK = 105MHz 
#define LoSPEED_CLOCK_DIVIDER   2   //!< LSCLK = 52,5 MHz
