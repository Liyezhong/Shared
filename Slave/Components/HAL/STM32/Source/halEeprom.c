...
/*****************************************************************************/
/*!
 *  \brief   Waits until all actvities on the EEPROM are finished
 *
 *      This function waits until all read and write operations on the EEPROM
