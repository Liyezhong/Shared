...
/***********************************************************************************/
/*!
 *  \brief   AD779x channel descriptor table
 *
...
const halAd779xDescriptor_t halAd779xDescriptors[] = {
    { HAL_BUS_SPI_B, 1, 1, 0xFF, 0x1234, 0x1234 },
    { HAL_BUS_SPI_B, 2, 2, 0xFF, 0x1234, 0x1234 }
};
...
const halExtIntrDescriptor_t halExtIntrDescriptors[] = {
    { HAL_INTERRUPT_0, PORT_A, 0, IRQ_PRIO_DEFAULT, IRQ_EDGE_NONE }
};
