...
#endif
#if defined( ENABLE_REMOTE_SESSION)
l37 e l2062(l94*l85);l37 a*l2237(l94*l85);l37 g l2046(l94*l85,e l344);
l37 g l2254(l94*l85);l37 g l2117(l94*l85,b l153);l37 g l2114(l94*l85,
b l153);l37 c l2018(l94*l85,g l38);l37 e l2234(l94*l85);l37 e l2240(
l94*l85);l37 e l2131(l94*l85,l65*l30);l145 l2295={(c( * )(l55* ))l918
,(e( * )(l55* ))l2062,(a* ( * )(l55* ))l2237,(g( * )(l55* ,e))l2046,(
g( * )(l55* ))l2254,(g( * )(l55* ,b))l2117,(g( * )(l55* ,b))l2114,(c(
 * )(l55* ,g))l2018,(e( * )(l55* ))l2234,(e( * )(l55* ))l2240};l94*
l1378(l65*l30){l94*l85;l85=(l94* )l275(l72(l94));k(!l85)w l52;l274(
l85,0,l72(l94));k(!l2131(l85,l30)){l918(l85);w l52;}l85->l31=&l2295;
l85->l30=l30;l85->l48=l1551;w l85;}c l918(l94*l85){k(l85->l765)l161(
l85->l765);l161(l85);}g l1119(l94*l85){m l284;p l35;g l71;l284.l114=
0x7fffffffL;l284.l116=0;l35=l85->l30->l77->l143?l85->l30->l77->l1047:
l85->l30->l77->l961;l85->l110=l921(l626,(l55* )l85,l85->l30->l77->l68
,l35,&l284);k(!l85->l110)w l323;l71=( * (l85->l110)->l31->l248)(l85->
l110);k(l71!=l138){l678(l626->l628,l85->l110);( * (l85->l110)->l31->
l107)(l85->l110);l85->l181=1;l85->l110=l52;}l85->l48=l973;w l71;}g
l1209(l94*l85){k(l85->l110){( * (l85->l110)->l31->l651)(l85->l110);
l85->l110=l52;l85->l48=l1299;}l89 l918(l85);w l138;}g l1282(l94*l85,a
 *i,b l,b*l87){ *l87=l;l85->l227=l87;( * (l85->l110)->l31->l250)(l85
->l110,i,l,1);w l138;}g l1142(l94*l85,a*i,b l,b*l87){ *l87=l;l85->
l322=l87;( * (l85->l110)->l31->l249)(l85->l110,i,l,1);w l138;}e l1308
(l94*l85){k(l85->l110)w l942(l85->l110);w 0;}l37 e l2062(l94*l85){w(
l85->l48==l1299);}l37 a*l2237(l94*l85){k(l85->l110)w l85->l110->l34;w
l52;}l37 g l2046(l94*l85,e l344){g l71;l71=l138;k(l85->l48==l973){
#if defined( HAVE_OPENSSL) && defined( ENABLE_SSL)
k(l85->l30->l77->l143)l950(l85->l110);
#endif
l85->l48=l990;( * (l85->l110)->l31->l250)(l85->l110,l85->l765,l85->
l1026,1);}l89 l71=l670;w l71;}l37 g l2254(l94*l85){g l71=l138;l85->
l48=l1186;l85->l110=l52;k(l176.l163>=l214)( *l188)(l214,0x00000008,""
...
"\x6e\x65\x63\x74\x69\x6f\x6e\x20\x63\x6c\x6f\x73\x65\x64",l85->l30->
l127);w l71;}l37 g l2117(l94*l85,b l153){ *l85->l322-=l153;w l138;}
l37 g l2114(l94*l85,b l153){k(l85->l48==l990){l85->l48=l1264;k(l176.
l163>=l214)( *l188)(l214,0x00000008,"\x52\x65\x6d\x6f\x74\x65\x20\x73"
...
"\x65\x73\x74\x61\x62\x6c\x69\x73\x68\x65\x64",l85->l30->l127);}l89*
l85->l227-=l153;w l138;}l37 c l2018(l94*l85,g l38){k(l85->l110){( * (
l85->l110)->l31->l651)(l85->l110);l85->l110=l52;}k(l176.l163>=l270)( *
l188)(l270,0x00000008,"\x52\x65\x6d\x6f\x74\x65\x20\x73\x65\x73\x73"
...
"\x6f\x72\x3a\x20\x25\x73",l85->l30->l127,((l38)>=0&&(l38)<l762?l341[
(l38)]:l52));l85->l48=l1186;l85->l181=1;}l37 e l2234(l94*l85){w 1;}
l37 e l2240(l94*l85){w 1;}l37 e l2131(l94*l85,l65*l30){b l1886=l212(
l30->l127);l85->l1026=l1886+2;l85->l765=l275(l85->l1026);k(!l85->l765
)w 0;l85->l765[0]=1;l85->l765[1]=(a)l1886;l600(l85->l765+2,l30->l127,
l1886);w 1;}
#endif
