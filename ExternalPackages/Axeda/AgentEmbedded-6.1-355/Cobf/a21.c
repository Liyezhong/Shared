...
#endif
#if defined( ENABLE_REMOTE_SESSION)
l37 e l2082(l100*l90);l37 a*l2167(l100*l90);l37 g l2265(l100*l90,e
l344);l37 g l2044(l100*l90);l37 g l2149(l100*l90,b l153);l37 g l2144(
l100*l90,b l153);l37 c l1973(l100*l90,g l38);l37 e l2179(l100*l90);
l37 e l2186(l100*l90);l145 l2291={(c( * )(l55* ))l1003,(e( * )(l55* ))l2082
,(a* ( * )(l55* ))l2167,(g( * )(l55* ,e))l2265,(g( * )(l55* ))l2044,(
g( * )(l55* ,b))l2149,(g( * )(l55* ,b))l2144,(c( * )(l55* ,g))l1973,(
e( * )(l55* ))l2179,(e( * )(l55* ))l2186};l100*l1202(l65*l30,b l174){
l100*l90;l90=(l100* )l275(l72(l100));k(!l90)w l52;l274(l90,0,l72(l100
));l90->l31=&l2291;l90->l30=l30;l90->l48=l1088;l90->l174=l174;w l90;}
c l1003(l100*l90){l161(l90);}l27 l1196(j l159,j l160){k(((l100* )l159
)->l174==((l100* )l160)->l174)w 0;w 1;}g l1224(l100*l90){m l284;g l71
;l284.l114=0x7fffffffL;l284.l116=0;l90->l110=l921(l626,(l55* )l90,l90
->l30->l154->l68,l90->l30->l154->l35,&l284);k(!l90->l110)w l323;l71=(
 * (l90->l110)->l31->l248)(l90->l110);k(l71!=l138){l678(l626->l628,
l90->l110);( * (l90->l110)->l31->l107)(l90->l110);l90->l181=1;l90->
l110=l52;}l90->l48=l1101;w l71;}g l1010(l100*l90){k(l90->l110){( * (
l90->l110)->l31->l651)(l90->l110);l90->l110=l52;l90->l48=l1346;}l89
l1003(l90);w l138;}g l1170(l100*l90,a*i,b l,b*l87){ *l87=l;l90->l227=
l87;( * (l90->l110)->l31->l250)(l90->l110,i,l,1);w l138;}g l1132(l100
 *l90,a*i,b l,b*l1102){ *l1102=0;l90->l1360=l1102;( * (l90->l110)->
l31->l249)(l90->l110,i,l,0);w l138;}e l1278(l100*l90){w l899(l90->
l110);}l37 e l2082(l100*l90){w(l90->l48==l1346);}l37 a*l2167(l100*l90
){k(l90->l110)w l90->l110->l34;w l52;}l37 g l2265(l100*l90,e l344){g
l71;l71=l138;k(l90->l48==l1101){l90->l48=l1127;k(l176.l163>=l214)( *
l188)(l214,0x00000008,"\x52\x65\x6d\x6f\x74\x65\x20\x73\x65\x73\x73"
"\x69\x6f\x6e\x20\x28\x69\x64\x3d\x25\x73\x29\x3a\x20\x63\x68\x61\x6e"
"\x6e\x65\x6c\x20\x25\x64\x20\x63\x6f\x6e\x6e\x65\x63\x74\x65\x64",
l90->l30->l127,l90->l174);}l89 l71=l670;w l71;}l37 g l2044(l100*l90){
g l71=l138;l90->l48=l1020;l90->l110=l52;k(l176.l163>=l214)( *l188)(
l214,0x00000008,"\x52\x65\x6d\x6f\x74\x65\x20\x73\x65\x73\x73\x69\x6f"
"\x6e\x20\x28\x69\x64\x3d\x25\x73\x29\x3a\x20\x63\x68\x61\x6e\x6e\x65"
"\x6c\x20\x25\x64\x20\x64\x69\x73\x63\x6f\x6e\x6e\x65\x63\x74\x65\x64"
,l90->l30->l127,l90->l174);w l71;}l37 g l2149(l100*l90,b l153){ *l90
->l1360=l153;l90->l30->l605.l48=l1355;l90->l30->l605.l203.l292.l601=
l90->l174;w l138;}l37 g l2144(l100*l90,b l153){ *l90->l227-=l153;w
l138;}l37 c l1973(l100*l90,g l38){k(l90->l110){( * (l90->l110)->l31->
l651)(l90->l110);l90->l110=l52;}k(l176.l163>=l270)( *l188)(l270,
0x00000008,"\x52\x65\x6d\x6f\x74\x65\x20\x73\x65\x73\x73\x69\x6f\x6e"
"\x20\x28\x69\x64\x3d\x25\x73\x29\x3a\x20\x65\x72\x72\x6f\x72\x20\x6f"
"\x6e\x20\x63\x68\x61\x6e\x6e\x65\x6c\x20\x25\x64\x3a\x20\x25\x73",
l90->l30->l127,l90->l174,((l38)>=0&&(l38)<l762?l341[(l38)]:l52));l90
->l48=l1020;l90->l181=1;}l37 e l2179(l100*l90){k(l90->l30->l605.l48==
l845)w 1;l90->l110->l664=0;w 0;}l37 e l2186(l100*l90){w 1;}
#endif
