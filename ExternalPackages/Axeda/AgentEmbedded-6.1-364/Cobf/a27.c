...
#endif
#endif
x*l816(c){x*o;o=(x* )l281(l72(x));k(!o)w l52;l270(o,0,l72(x));o->l43=
l52;l178(&o->l313,"\x31\x2e\x31",-1);l178(&o->l51,"\x47\x45\x54",-1);
o->l34=l52;o->l35=80;l178(&o->l109,"\x2f",-1);o->l106=l52;o->l105=l52
;o->l235=l52;o->l797=l52;o->l801=0;o->l725=0;o->l1035=0;o->l142=0;o->
l276.l115=30;o->l276.l116=0;o->l290=l52;o->l277=l52;o->l292=0;o->l38=
l138;o->l95=l52;o->l729=l52;o->l707=l52;o->l800=l52;o->l698=l52;o->
l674=l52;w o;}c l632(x*o){k(o->l43)l775(o->l43);k(o->l313)l161(o->
l313);k(o->l51)l161(o->l51);k(o->l34)l161(o->l34);k(o->l109)l161(o->
l109);k(o->l106)l161(o->l106);k(o->l105)l161(o->l105);k(o->l235)l161(
o->l235);k(o->l290)l825((l79* )o->l290);k(o->l277)l825((l79* )o->l277
);l161(o);}e l811(x*o,a*l183){l98*l43;k(!o->l43){o->l43=l798();k(!o->
l43)w 0;}l43=(l98* )o->l43;k(!l819(l43,l183))w 0;
#if defined( HAVE_OPENSSL) && defined( ENABLE_SSL)
((o)->l142=(l43->l142));
#endif
l1274(o,l43->l34);((o)->l35=(l43->l35));l1262(o,l43->l109);l1358(o,
l43->l106);l1130(o,l43->l105);w 1;}a*l1482(x*o){l98*l43;k(!o->l43){o
->l43=l798();k(!o->l43)w l52;}l43=(l98* )o->l43;
#if defined( HAVE_OPENSSL) && defined( ENABLE_SSL)
((l43)->l142=(o->l142));
#endif
l940(l43,o->l34);((l43)->l35=(o->l35));l895(l43,o->l109);l1154(l43,o
->l106);l1126(l43,o->l105);w l890(l43);}c l1078(x*o,a*l313){l178(&o->
l313,l313,-1);}c l820(x*o,a*l51){l178(&o->l51,l51,-1);}c l1274(x*o,a*
l34){l178(&o->l34,l34,-1);}c l1262(x*o,a*l109){k(!l109||l109[0]=='\0'
)l178(&o->l109,"\x2f",1);l89 l178(&o->l109,l109,-1);}c l1358(x*o,a*
l106){l178(&o->l106,l106,-1);}c l1130(x*o,a*l105){l178(&o->l105,l105,
-1);}c l1546(x*o,a*l235){l178(&o->l235,l235,-1);}c l1240(x*o,a*u,a*
l78){k(!o->l290){o->l290=l873();k(!o->l290)w;}l656((l79* )o->l290,u,
l78);}c l1289(x*o,a*u,a*l78){k(!o->l277){o->l277=l873();k(!o->l277)w;
}l656((l79* )o->l277,u,l78);}a*l1321(x*o,a*u){l42*l67;k(!o->l277)w l52
;l67=((l79* )o->l277)->l291;l241(l67){l67=(l67)->l166;k(!l655(((l610*
)(l67)->i)->u,u))w((l610* )(l67)->i)->l78;}w l52;}j l1420(x*o,a* *
l337,a* *l339){l42*l67;k(!o->l277)w l52;l67=((l79* )o->l277)->l291;k(
l67){ *l337=((l610* )(l67)->i)->u; *l339=((l610* )(l67)->i)->l78;}w
l67;}j l1527(x*o,j l1385,a* *l337,a* *l339){l42*l67;l67=(l42* )l1385;
k(l67){l67=(l67)->l166;k(l67){ *l337=((l610* )(l67)->i)->u; *l339=((
l610* )(l67)->i)->l78;}}w l67;}c l1067(x*o){o->l292=0;o->l38=l138;k(o
->l277)l825((l79* )o->l277);o->l277=l52;}
