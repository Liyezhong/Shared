...
#endif
#if defined( ENABLE_REMOTE_SESSION)
l37 e l2081(l100*l90);l37 a*l2167(l100*l90);l37 g l2266(l100*l90,e
l345);l37 g l2044(l100*l90);l37 g l2149(l100*l90,b l153);l37 g l2145(
l100*l90,b l153);l37 c l1972(l100*l90,g l38);l37 e l2179(l100*l90);
l37 e l2186(l100*l90);l145 l2291={(c( * )(l55* ))l994,(e( * )(l55* ))l2081
,(a* ( * )(l55* ))l2167,(g( * )(l55* ,e))l2266,(g( * )(l55* ))l2044,(
g( * )(l55* ,b))l2149,(g( * )(l55* ,b))l2145,(c( * )(l55* ,g))l1972,(
e( * )(l55* ))l2179,(e( * )(l55* ))l2186};l100*l1206(l65*l30,b l171){
l100*l90;l90=(l100* )l281(l72(l100));k(!l90)w l52;l270(l90,0,l72(l100
));l90->l31=&l2291;l90->l30=l30;l90->l48=l1086;l90->l171=l171;w l90;}
c l994(l100*l90){l161(l90);}l27 l1204(j l160,j l159){k(((l100* )l160)->
l171==((l100* )l159)->l171)w 0;w 1;}g l1226(l100*l90){m l276;g l71;
l276.l115=0x7fffffffL;l276.l116=0;l90->l110=l917(l622,(l55* )l90,l90
->l30->l154->l68,l90->l30->l154->l35,&l276);k(!l90->l110)w l323;l71=(
 * (l90->l110)->l31->l249)(l90->l110);k(l71!=l138){l680(l622->l630,
l90->l110);( * (l90->l110)->l31->l107)(l90->l110);l90->l181=1;l90->
l110=l52;}l90->l48=l1100;w l71;}g l1004(l100*l90){k(l90->l110){( * (
l90->l110)->l31->l652)(l90->l110);l90->l110=l52;l90->l48=l1348;}l89
l994(l90);w l138;}g l1171(l100*l90,a*i,b l,b*l86){ *l86=l;l90->l228=
l86;( * (l90->l110)->l31->l250)(l90->l110,i,l,1);w l138;}g l1136(l100
 *l90,a*i,b l,b*l1101){ *l1101=0;l90->l1361=l1101;( * (l90->l110)->
l31->l247)(l90->l110,i,l,0);w l138;}e l1281(l100*l90){w l898(l90->
l110);}l37 e l2081(l100*l90){w(l90->l48==l1348);}l37 a*l2167(l100*l90
){k(l90->l110)w l90->l110->l34;w l52;}l37 g l2266(l100*l90,e l345){g
l71;l71=l138;k(l90->l48==l1100){l90->l48=l1131;k(l172.l163>=l214)( *
...
l90->l30->l125,l90->l171);}l89 l71=l682;w l71;}l37 g l2044(l100*l90){
g l71=l138;l90->l48=l1019;l90->l110=l52;k(l172.l163>=l214)( *l189)(
...
,l90->l30->l125,l90->l171);w l71;}l37 g l2149(l100*l90,b l153){ *l90
->l1361=l153;l90->l30->l605.l48=l1355;l90->l30->l605.l202.l293.l602=
l90->l171;w l138;}l37 g l2145(l100*l90,b l153){ *l90->l228-=l153;w
l138;}l37 c l1972(l100*l90,g l38){k(l90->l110){( * (l90->l110)->l31->
l652)(l90->l110);l90->l110=l52;}k(l172.l163>=l271)( *l189)(l271,
...
l90->l30->l125,l90->l171,((l38)>=0&&(l38)<l761?l341[(l38)]:l52));l90
->l48=l1019;l90->l181=1;}l37 e l2179(l100*l90){k(l90->l30->l605.l48==
l849)w 1;l90->l110->l665=0;w 0;}l37 e l2186(l100*l90){w 1;}
#endif
