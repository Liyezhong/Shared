...
#endif
#if defined( ENABLE_REMOTE_SESSION)
l37 c l1883(l240*r);l37 c l2191(l240*r);l37 c l2075(l240*r,a*i,b l,b*
l86);l37 c l2080(l240*r);l37 c l2137(l240*r,a*i,b l,b*l86);l37 c l1843
(l240*r);l37 c l2124(l240*r);l37 c l2219(l240*r);l37 e l2170(l240*r);
l37 e l2212(l240*r);l37 e l2065(l240*r);l37 e l2054(l240*r);l37 c
l1922(a* *l2035,a*l43,e l142,a*l68,p l35);l37 c l1919(l240*r,x*o);l37
c l1947(x*o,g l38);l37 e l2175(x*o,b l742,a*i,b l);l37 c l1872(x*o);
l393 l2287={(c( * )(z* ))l1883,(c( * )(z* ))l2191,(c( * )(z* ,a* ,b,b
 * ))l2075,(c( * )(z* ,a* ,b,b* ))l2137,(e( * )(z* ))l2170,(e( * )(z*
))l2212,(e( * )(z* ))l2065,(e( * )(z* ))l2054};l240*l1374(l65*l30){
l196*l77=l30->l77;l240*r;p l35;r=(l240* )l281(l72(l240));k(!r)w l52;
l270(r,0,l72(l240));l1024((z* )&r->l91,"\x48\x54\x54\x50",l30);r->l91
.l31=&l2287;r->l777=l739(l52,0,l741);k(!r->l777){l1883(r);w l52;}l35=
l77->l142?l77->l986:l77->l981;l1922(&r->l336,l77->l336,l77->l142,l77
->l68,l35);l1922(&r->l312,l77->l312,l77->l142,l77->l68,l35);w r;}c
l1883(l240*r){k(r->l623)((r->l623)->l95=(l52));k(r->l615)((r->l615)->
l95=(l52));k(r->l336)l161(r->l336);k(r->l312)l161(r->l312);k(r->l777)l730
(r->l777);l161(r);}l37 c l2191(l240*r){}l37 c l2075(l240*r,a*i,b l,b*
l86){r->l333=i;r->l228=l86; *r->l228=l;l2080(r);}l37 c l2080(l240*r){
r->l615=l816();k(!r->l615){r->l181=1;w;}l820(r->l615,"\x50\x4f\x53"
"\x54");l811(r->l615,r->l336);((r->l615)->l725=(1));((r->l615)->l797=
(r->l333));((r->l615)->l801=( *r->l228));((r->l615)->l95=(r));((r->
l615)->l707=(l1947));((r->l615)->l698=(l52));((r->l615)->l674=(l1872));
k(l767(l622,&r->l615,1)!=l138){l632(r->l615);r->l615=l52;r->l181=1;}}
l37 c l2137(l240*r,a*i,b l,b*l86){r->l325=i;r->l319=l86; *r->l319=l;
l1843(r);}l37 c l1843(l240*r){k(!r->l319)w;l2124(r);k( *r->l319>0){k(
r->l623==l52)l2219(r);}l89{r->l325=l52;r->l319=l52;}}l37 c l2124(l240
 *r){a*l1977;b l1857;l678(r->l777,&l1977,&l1857);k(l1857>0&& *r->l319
>0){b l1838=(( *r->l319)<(l1857)?( *r->l319):(l1857));l599(r->l325,
l1977,l1838);r->l325+=l1838; *r->l319-=l1838;l700(r->l777,l1838,1);}}
l37 c l2219(l240*r){r->l623=l816();k(!r->l623){r->l181=1;w;}l820(r->
l623,"\x47\x45\x54");l811(r->l623,r->l312);((r->l623)->l725=(1));((r
->l623)->l95=(r));((r->l623)->l707=(l1947));((r->l623)->l698=(l2175));
((r->l623)->l674=(l1872));k(l767(l622,&r->l623,1)!=l138){l632(r->l623
);r->l623=l52;r->l181=1;}}l37 e l2170(l240*r){w 0;}l37 e l2212(l240*r
){w 1;}l37 e l2065(l240*r){k(r->l228&& *r->l228>0)w 1;w 0;}l37 e l2054
(l240*r){w r->l181;}l37 c l1922(a* *l2035,a*l43,e l142,a*l68,p l35){
l98*l1712;l1712=l798();k(!l1712)w;k(!l819(l1712,l43)){l775(l1712);w;}
((l1712)->l142=(l142));k(l68)l940(l1712,l68);((l1712)->l35=(l35));
l178(l2035,l890(l1712),-1);l775(l1712);}l37 c l1919(l240*r,x*o){k(o==
r->l615){r->l615=l52;r->l333=l52;r->l228=l52;}k(o==r->l623){r->l623=
l52;r->l325=l52;r->l319=l52;}r->l181=1;}l37 c l1947(x*o,g l38){l240*r
=(l240* )o->l95;k(r){r->l181=1;k(l172.l163>=l271)( *l189)(l271,
...
"\x20\x65\x72\x72\x6f\x72\x3a\x20\x25\x73",r->l91.l30->l125,o->l51,((
l38)>=0&&(l38)<l761?l341[(l38)]:l52));l1919(r,o);}l632(o);}l37 e l2175
(x*o,b l742,a*i,b l){l240*r=(l240* )o->l95;k(r){l307(r->l777,i,l);
l1843(r);}w 1;}l37 c l1872(x*o){l240*r=(l240* )o->l95;k(r){k(o->l292
!=200){k(l172.l163>=l271)( *l189)(l271,0x00000008,"\x52\x65\x6d\x6f"
"\x74\x65\x20\x73\x65\x73\x73\x69\x6f\x6e\x20\x28\x69\x64\x3d\x25\x73"
"\x29\x3a\x20\x48\x54\x54\x50\x20\x25\x73\x20\x73\x74\x61\x74\x75\x73"
"\x3a\x20\x25\x64",r->l91.l30->l125,o->l51,o->l292);l1919(r,o);}l89{k
(o==r->l615){r->l615=l52;r->l333=l52; *r->l228=0;r->l228=l52;}l89{r->
l623=l52;l1843(r);}}}l632(o);}
#endif
