...
#endif
#if defined( ENABLE_REMOTE_SESSION)
l37 e l2061(l94*l87);l37 a*l2237(l94*l87);l37 g l2046(l94*l87,e l345);
l37 g l2254(l94*l87);l37 g l2117(l94*l87,b l153);l37 g l2114(l94*l87,
b l153);l37 c l2018(l94*l87,g l38);l37 e l2234(l94*l87);l37 e l2240(
l94*l87);l37 e l2131(l94*l87,l65*l30);l145 l2295={(c( * )(l55* ))l919
,(e( * )(l55* ))l2061,(a* ( * )(l55* ))l2237,(g( * )(l55* ,e))l2046,(
g( * )(l55* ))l2254,(g( * )(l55* ,b))l2117,(g( * )(l55* ,b))l2114,(c(
 * )(l55* ,g))l2018,(e( * )(l55* ))l2234,(e( * )(l55* ))l2240};l94*
l1378(l65*l30){l94*l87;l87=(l94* )l281(l72(l94));k(!l87)w l52;l270(
l87,0,l72(l94));k(!l2131(l87,l30)){l919(l87);w l52;}l87->l31=&l2295;
l87->l30=l30;l87->l48=l1552;w l87;}c l919(l94*l87){k(l87->l762)l161(
l87->l762);l161(l87);}g l1142(l94*l87){m l276;p l35;g l71;l276.l115=
0x7fffffffL;l276.l116=0;l35=l87->l30->l77->l142?l87->l30->l77->l1038:
l87->l30->l77->l969;l87->l110=l917(l622,(l55* )l87,l87->l30->l77->l68
,l35,&l276);k(!l87->l110)w l323;l71=( * (l87->l110)->l31->l249)(l87->
l110);k(l71!=l138){l680(l622->l630,l87->l110);( * (l87->l110)->l31->
l107)(l87->l110);l87->l181=1;l87->l110=l52;}l87->l48=l973;w l71;}g
l1213(l94*l87){k(l87->l110){( * (l87->l110)->l31->l652)(l87->l110);
l87->l110=l52;l87->l48=l1299;}l89 l919(l87);w l138;}g l1284(l94*l87,a
 *i,b l,b*l86){ *l86=l;l87->l228=l86;( * (l87->l110)->l31->l250)(l87
->l110,i,l,1);w l138;}g l1146(l94*l87,a*i,b l,b*l86){ *l86=l;l87->
l319=l86;( * (l87->l110)->l31->l247)(l87->l110,i,l,1);w l138;}e l1307
(l94*l87){k(l87->l110)w l923(l87->l110);w 0;}l37 e l2061(l94*l87){w(
l87->l48==l1299);}l37 a*l2237(l94*l87){k(l87->l110)w l87->l110->l34;w
l52;}l37 g l2046(l94*l87,e l345){g l71;l71=l138;k(l87->l48==l973){
#if defined( HAVE_OPENSSL) && defined( ENABLE_SSL)
k(l87->l30->l77->l142)l951(l87->l110);
#endif
l87->l48=l1105;( * (l87->l110)->l31->l250)(l87->l110,l87->l762,l87->
l1096,1);}l89 l71=l682;w l71;}l37 g l2254(l94*l87){g l71=l138;l87->
l48=l1188;l87->l110=l52;k(l172.l163>=l214)( *l189)(l214,0x00000008,""
...
"\x6e\x65\x63\x74\x69\x6f\x6e\x20\x63\x6c\x6f\x73\x65\x64",l87->l30->
l125);w l71;}l37 g l2117(l94*l87,b l153){ *l87->l319-=l153;w l138;}
l37 g l2114(l94*l87,b l153){k(l87->l48==l1105){l87->l48=l1276;k(l172.
l163>=l214)( *l189)(l214,0x00000008,"\x52\x65\x6d\x6f\x74\x65\x20\x73"
...
"\x65\x73\x74\x61\x62\x6c\x69\x73\x68\x65\x64",l87->l30->l125);}l89*
l87->l228-=l153;w l138;}l37 c l2018(l94*l87,g l38){k(l87->l110){( * (
l87->l110)->l31->l652)(l87->l110);l87->l110=l52;}k(l172.l163>=l271)( *
l189)(l271,0x00000008,"\x52\x65\x6d\x6f\x74\x65\x20\x73\x65\x73\x73"
...
"\x6f\x72\x3a\x20\x25\x73",l87->l30->l125,((l38)>=0&&(l38)<l761?l341[
(l38)]:l52));l87->l48=l1188;l87->l181=1;}l37 e l2234(l94*l87){w 1;}
l37 e l2240(l94*l87){w 1;}l37 e l2131(l94*l87,l65*l30){b l1887=l213(
l30->l125);l87->l1096=l1887+2;l87->l762=l281(l87->l1096);k(!l87->l762
)w 0;l87->l762[0]=1;l87->l762[1]=(a)l1887;l599(l87->l762+2,l30->l125,
l1887);w 1;}
#endif
