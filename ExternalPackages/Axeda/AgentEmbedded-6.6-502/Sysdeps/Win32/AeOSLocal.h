...
#define AeStrToTime(s, e, r) ((time_t) _strtoi64(s, e, r))
#define AE_TIME_FORMAT_MODIFIER AE_INT64_FORMAT_MODIFIER
#else
#define AeStrToTime(s, e, r) ((time_t) strtol(s, e, r))
#define AE_TIME_FORMAT_MODIFIER AE_INT32_FORMAT_MODIFIER
#endif
