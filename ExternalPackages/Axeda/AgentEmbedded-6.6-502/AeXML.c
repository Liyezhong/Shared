...
static AeXMLAttribute *AeXMLElementFindAttribute(AeXMLElement *pElement, AeChar *pName);
...
/******************************************************************************/
AeXMLAttribute *AeXMLElementSetAttribute(AeXMLElement *pElement, AeChar *pName, AeChar *pValue)
{
    AeXMLAttribute *pAttribute = AeXMLElementFindAttribute(pElement, pName);
    if (pAttribute)
    {
        AeXMLAttributeSetValue(pAttribute, pValue);
        return pAttribute;
    ...
    return AeXMLElementAddAttribute(pElement, pName, pValue);
}
...
static AeXMLAttribute *AeXMLElementFindAttribute(AeXMLElement *pElement, AeChar *pName)
{
    ...
    while (pAttribute)
    {
        if (!strcmp(pAttribute->pName, pName))
            return pAttribute;
