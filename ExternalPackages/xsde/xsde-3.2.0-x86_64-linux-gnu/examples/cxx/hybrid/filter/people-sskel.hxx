...
#ifndef PEOPLE_SSKEL_HXX
#define PEOPLE_SSKEL_HXX
...
class gender_sskel: public ::xml_schema::string_sskel
{
  ...
  protected:
  gender_sskel* gender_impl_;
  gender_sskel (gender_sskel*, void*);

  protected:
  static const char* const _xsde_gender_sskel_enums_[2UL];
};
...
class person_sskel: public ::xsde::cxx::serializer::validating::complex_content
{
  ...
  void
  age_serializer (::xml_schema::unsigned_short_sskel&);
  ...
  protected:
  ::xml_schema::string_sskel* first_name_serializer_;
  ::xml_schema::string_sskel* last_name_serializer_;
  ::gender_sskel* gender_serializer_;
  ::xml_schema::unsigned_short_sskel* age_serializer_;
};

class people_sskel: public ::xsde::cxx::serializer::validating::complex_content
{
  public:
  // Serializer callbacks. Override them in your implementation.
  //
  ...
  protected:
  people_sskel* people_impl_;
  people_sskel (people_sskel*, void*);

  protected:
  ::person_sskel* person_serializer_;
};

#include "people-sskel.ixx"
