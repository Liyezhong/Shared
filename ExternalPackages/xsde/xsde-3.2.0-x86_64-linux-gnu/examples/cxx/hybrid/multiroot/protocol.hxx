...
namespace protocol
{
  ...
  // balance (fixed-length)
  //
  class balance: public ::protocol::request
  {
    public:
    balance ();
  ...
  // withdraw (fixed-length)
  //
  class withdraw: public ::protocol::request
  {
    public:
    withdraw ();

    withdraw (const withdraw&);
    withdraw& operator= (const withdraw&);
  ...
  // deposit (fixed-length)
  //
  class deposit: public ::protocol::request
  {
    public:
    deposit ();
