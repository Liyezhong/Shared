...
#ifndef POSITION_SSKEL_HXX
#define POSITION_SSKEL_HXX
...
class position_sskel: public ::xsde::cxx::serializer::validating::complex_content
{
  public:
  ...
  //
  void
  lat_serializer (::xml_schema::float_sskel&);

  void
  lon_serializer (::xml_schema::float_sskel&);
  ...
  protected:
  position_sskel* position_impl_;
  position_sskel (position_sskel*, void*);

  protected:
  ::xml_schema::float_sskel* lat_serializer_;
  ::xml_schema::float_sskel* lon_serializer_;
};

class object_sskel: public ::xsde::cxx::serializer::validating::complex_content
{
  public:
  // Serializer callbacks. Override them in your implementation.
  //
  ...
  //
  void
  position_serializer (::position_sskel&);
  ...
  protected:
  object_sskel* object_impl_;
  object_sskel (object_sskel*, void*);

  protected:
  ::xml_schema::unsigned_int_sskel* id_serializer_;
  ::position_sskel* position_serializer_;
};

#include "position-sskel.ixx"
