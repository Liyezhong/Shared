...
namespace email
{
  class binary_pskel: public ::xml_schema::base64_binary_pskel
  {
    public:
  ...
  class envelope_pskel: public ::xsde::cxx::parser::validating::complex_content
  {
    public:
    // Parser callbacks. Override them in your implementation.
    //
    ...
    //
    protected:
    envelope_pskel* envelope_impl_;
    envelope_pskel (envelope_pskel*, void*);
    ...
    {
      void (::email::envelope_pskel::*func) (
        unsigned long&,
        unsigned long&,
        const ::xsde::cxx::ro_string&,
        const ::xsde::cxx::ro_string&,
