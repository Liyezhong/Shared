...
#ifndef HELLO_SSKEL_HXX
#define HELLO_SSKEL_HXX
...
class hello_sskel: public ::xsde::cxx::serializer::validating::complex_content
{
  public:
  ...
  protected:
  hello_sskel* hello_impl_;
  hello_sskel (hello_sskel*, void*);

  protected:
  ::xml_schema::string_sskel* greeting_serializer_;
  ::xml_schema::string_sskel* name_serializer_;
};

#include "hello-sskel.ixx"
