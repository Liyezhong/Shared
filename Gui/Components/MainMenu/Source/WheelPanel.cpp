...
CWheelPanel::CWheelPanel(QWidget *p_Parent) : QWidget(p_Parent)
{
    ...
    m_PanelPixmap = QPixmap(QString(":/%1/Digits/Digit_Panel.png").arg(Application::CLeicaStyle::GetStyleSizeString()));
...
void CWheelPanel::SetThreeDigitMode(bool Mode)
{
	...
	setMinimumSize(137,277);
        m_PanelPixmap = QPixmap(QString(":/%1/Digits/Digit_Panel_3_digits.png").arg(Application::CLeicaStyle::GetStyleSizeString()));
...
void CWheelPanel::AddSeparator(SeparatorType_t Type, qint32 Position)
{
    switch (Type) {
        case COLON:
            m_SeparatorList[Position]->setPixmap(QPixmap(QString(":/%1/Digits/Digit_Colon.png").arg(Application::CLeicaStyle::GetStyleSizeString())).copy(7, 43, 4, 188));
            break;
        case FULLSTOP:
            m_SeparatorList[Position]->setPixmap(QPixmap(QString(":/%1/Digits/Digit_FullStopp.png").arg(Application::CLeicaStyle::GetStyleSizeString())).copy(7, 43, 4, 188));
            break;
        default:
            break;
    }
...
void CWheelPanel::paintEvent(QPaintEvent *)
{
    ...
    QPixmap Source(QString(":/%1/Digits/Digit_Panel.png").arg(Application::CLeicaStyle::GetStyleSizeString()));
    QPixmap Target(size());
