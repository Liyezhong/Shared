...
#endif
#if defined( ENABLE_REMOTE_SESSION)
l37 c l1882(l237*r);l37 c l2190(l237*r);l37 c l2075(l237*r,a*i,b l,b*
l87);l37 c l2080(l237*r);l37 c l2137(l237*r,a*i,b l,b*l87);l37 c l1842
(l237*r);l37 c l2124(l237*r);l37 c l2227(l237*r);l37 e l2170(l237*r);
l37 e l2212(l237*r);l37 e l2064(l237*r);l37 e l2054(l237*r);l37 c
l1921(a* *l2034,a*l43,e l143,a*l68,p l35);l37 c l1917(l237*r,x*o);l37
c l1945(x*o,g l38);l37 e l2174(x*o,b l766,a*i,b l);l37 c l1871(x*o);
l391 l2287={(c( * )(z* ))l1882,(c( * )(z* ))l2190,(c( * )(z* ,a* ,b,b
 * ))l2075,(c( * )(z* ,a* ,b,b* ))l2137,(e( * )(z* ))l2170,(e( * )(z*
))l2212,(e( * )(z* ))l2064,(e( * )(z* ))l2054};l237*l1327(l65*l30){
l199*l77=l30->l77;l237*r;p l35;r=(l237* )l275(l72(l237));k(!r)w l52;
l274(r,0,l72(l237));l985((z* )&r->l91,"\x48\x54\x54\x50",l30);r->l91.
l31=&l2287;r->l801=l738(l52,0,l742);k(!r->l801){l1882(r);w l52;}l35=
l77->l143?l77->l992:l77->l987;l1921(&r->l337,l77->l337,l77->l143,l77
->l68,l35);l1921(&r->l314,l77->l314,l77->l143,l77->l68,l35);w r;}c
l1882(l237*r){k(r->l623)((r->l623)->l95=(l52));k(r->l614)((r->l614)->
l95=(l52));k(r->l337)l161(r->l337);k(r->l314)l161(r->l314);k(r->l801)l728
(r->l801);l161(r);}l37 c l2190(l237*r){}l37 c l2075(l237*r,a*i,b l,b*
l87){r->l328=i;r->l227=l87; *r->l227=l;l2080(r);}l37 c l2080(l237*r){
r->l614=l820();k(!r->l614){r->l181=1;w;}l814(r->l614,"\x50\x4f\x53"
"\x54");l818(r->l614,r->l337);((r->l614)->l733=(1));((r->l614)->l800=
(r->l328));((r->l614)->l805=( *r->l227));((r->l614)->l95=(r));((r->
l614)->l716=(l1945));((r->l614)->l702=(l52));((r->l614)->l671=(l1871));
k(l743(l626,&r->l614,1)!=l138){l631(r->l614);r->l614=l52;r->l181=1;}}
l37 c l2137(l237*r,a*i,b l,b*l87){r->l326=i;r->l322=l87; *r->l322=l;
l1842(r);}l37 c l1842(l237*r){k(!r->l322)w;l2124(r);k( *r->l322>0){k(
r->l623==l52)l2227(r);}l89{r->l326=l52;r->l322=l52;}}l37 c l2124(l237
 *r){a*l1976;b l1856;l682(r->l801,&l1976,&l1856);k(l1856>0&& *r->l322
>0){b l1838=(( *r->l322)<(l1856)?( *r->l322):(l1856));l600(r->l326,
l1976,l1838);r->l326+=l1838; *r->l322-=l1838;l700(r->l801,l1838,1);}}
l37 c l2227(l237*r){r->l623=l820();k(!r->l623){r->l181=1;w;}l814(r->
l623,"\x47\x45\x54");l818(r->l623,r->l314);((r->l623)->l733=(1));((r
->l623)->l95=(r));((r->l623)->l716=(l1945));((r->l623)->l702=(l2174));
((r->l623)->l671=(l1871));k(l743(l626,&r->l623,1)!=l138){l631(r->l623
);r->l623=l52;r->l181=1;}}l37 e l2170(l237*r){w 0;}l37 e l2212(l237*r
){w 1;}l37 e l2064(l237*r){k(r->l227&& *r->l227>0)w 1;w 0;}l37 e l2054
(l237*r){w r->l181;}l37 c l1921(a* *l2034,a*l43,e l143,a*l68,p l35){
l98*l1711;l1711=l773();k(!l1711)w;k(!l834(l1711,l43)){l778(l1711);w;}
((l1711)->l143=(l143));k(l68)l938(l1711,l68);((l1711)->l35=(l35));
l178(l2034,l891(l1711),-1);l778(l1711);}l37 c l1917(l237*r,x*o){k(o==
r->l614){r->l614=l52;r->l328=l52;r->l227=l52;}k(o==r->l623){r->l623=
l52;r->l326=l52;r->l322=l52;}r->l181=1;}l37 c l1945(x*o,g l38){l237*r
=(l237* )o->l95;k(r){r->l181=1;k(l176.l163>=l270)( *l188)(l270,
...
"\x20\x65\x72\x72\x6f\x72\x3a\x20\x25\x73",r->l91.l30->l127,o->l51,((
l38)>=0&&(l38)<l762?l341[(l38)]:l52));l1917(r,o);}l631(o);}l37 e l2174
(x*o,b l766,a*i,b l){l237*r=(l237* )o->l95;k(r){l306(r->l801,i,l);
l1842(r);}w 1;}l37 c l1871(x*o){l237*r=(l237* )o->l95;k(r){k(o->l291
!=200){k(l176.l163>=l270)( *l188)(l270,0x00000008,"\x52\x65\x6d\x6f"
...
"\x3a\x20\x25\x64",r->l91.l30->l127,o->l51,o->l291);l1917(r,o);}l89{k
(o==r->l614){r->l614=l52;r->l328=l52; *r->l227=0;r->l227=l52;}l89{r->
l623=l52;l1842(r);}}}l631(o);}
#endif
