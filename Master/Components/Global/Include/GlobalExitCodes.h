...
const qint32  EXIT_CODE_EXPORT_INVALID_EXPORT                                  = 0x00a; ///< invalid type of Import
const qint32  EXIT_CODE_EXPORT_CRYTOSERVICE_RUNNING                            = 0x00b; ///< trying to run more than one Cryptoservice
const qint32  EXIT_CODE_EXPORT_CANNOT_OPEN_FILE_FOR_READ                       = 0x00c; ///< cannot open the file in read mode
const qint32  EXIT_CODE_EXPORT_CANNOT_OPEN_FILE_FOR_WRITE                      = 0x00d; ///< cannot open the file in write mode
const qint32  EXIT_CODE_EXPORT_UNABLE_TO_READ                                  = 0x00e; ///< unable to read the file
const qint32  EXIT_CODE_EXPORT_UNABLE_TO_WRITE                                 = 0x00f; ///< unable to write the file
