...
const qint32 ERROR_IMPORTEXPORT_UNABLE_TO_READ                = 0x007; ///< unable to read the file
const qint32 ERROR_IMPORTEXPORT_UNABLE_TO_WRITE               = 0x008; ///< unable to write the file
