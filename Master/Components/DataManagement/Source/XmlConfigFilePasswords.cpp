...
#include <DataManagement/Include/XmlConfigFilePasswords.h>
...
/****************************************************************************/
void XmlConfigFilePasswords::ReadPassword_V1(QXmlStreamReader &rReader, PasswordManager &rPasswordManager) {
...
/****************************************************************************/
void XmlConfigFilePasswords::ReadPasswords_V1(QXmlStreamReader &rReader, PasswordManager &rPasswordManager) {
    // read serial number
...
/****************************************************************************/
void XmlConfigFilePasswords::ReadPasswords(const QString &FileName, PasswordManager &rPasswordManager) {
    // reset data
...
/****************************************************************************/
void XmlConfigFilePasswords::WritePasswords(const QString &FileName, const PasswordManager &ThePasswordManager, const QString &SerialNumber) {
    // init stream writer
    ...
    tPasswordIterator it = ThePasswordManager.Iterator();
    while(it.hasNext()) {
        static_cast<void>(
