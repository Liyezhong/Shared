 ...
 */
/****************************************************************************/
CmdAlarmToneTest::CmdAlarmToneTest(int Timeout, quint8 Sound, quint8 Volume, Global::AlarmType AlarmType) :
                                   Command(Timeout),
                                   m_Sound(Sound),
                                   m_Volume(Volume),
 ...
 */
/****************************************************************************/
Global::AlarmType CmdAlarmToneTest::GetAlarmType() const
{
    return m_AlarmType;
}
