...
typedef enum {
    ...
    DCL_ERR_DEV_AL_DRAIN_SETUP_PRESSURE_TIMEOUT = ((((EVENT_SOURCE_DEV_AIR_LIQUID << 8) | EVENT_FUNC_DRAINING_PROCEDURE) << 8)| EVENT_CODE_TIMEOUT),//!< Draing setup pressure failed
...
typedef enum
{
    ...
    SYNC_CMD_RT_SET_TEMP_PID = 27,
    SYNC_CMD_RT_GET_TEMP_CTRL_STATE = 28,
    ...
    SYNC_CMD_OVEN_GET_TEMP_CTRL_STATE = 35,
