...
private:
    ErrorHandler(const ErrorHandler &);   ///< Not implemented.
...
signals:
    ...
    *
    *******************************************************************************/
    void SendErrorToRemoteCare(const DataLogging::DayEventEntry &);
...
public slots:
    ...
    *
    *******************************************************************************/
    virtual void ReceiveEvent(const DataLogging::DayEventEntry &, const quint32 EventKey) = 0;
