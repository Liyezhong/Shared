...
AeBool AeDemoProcessOptions(AeDemoConfig *pConfig, int *pargc, char *argv[], int iNonOptCount)
{
    ...
    pConfig->pRemoteSessionName = (AeChar*)"Desktop";
    pConfig->pRemoteSessionType = (AeChar*)"desktop";
    pConfig->pRemoteSessionHost = (AeChar*)"127.0.0.1";
    pConfig->iRemoteSessionPort = 5900;
