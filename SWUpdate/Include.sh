...
readonly EBOXCONFIGDIR="$EBOXINITSCRIPTSDIR/ebox-configurations"       #Path of ebox configuration scrips & files
readonly DEVRULESDIR="/etc/udev/rules.d"		#Path of ebox udev foulder for update local.rules
